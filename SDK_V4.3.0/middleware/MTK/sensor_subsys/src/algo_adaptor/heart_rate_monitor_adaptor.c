...
//#define THRESHOLD_PPG_WATCH_OFF 10000 // The AMB threshold of the PPG

#if defined (SOLTEAMOPTO) 
    #define THRESHOLD_PPG_WATCH_OFF 10000 // The AMB threshold of the PPG
#elif defined (OSRAM)
    #define THRESHOLD_PPG_WATCH_OFF -24400 
#else
    #define THRESHOLD_PPG_WATCH_OFF 20000 
#endif

#ifndef THRESHOLD_PPG_WATCH_OFF
#define THRESHOLD_PPG_WATCH_OFF	10000
#endif
...
int heart_rate_monitor_init(void)
{
    ...
    ppg_set_watch_off_threshold (THRESHOLD_PPG_WATCH_OFF);

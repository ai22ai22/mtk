...
/** 
 * @brief This function is applied to set the threshold of watch off detection fuction in the initial stage.
 * @param[in] ambient_threshold is the threshold for watch-off detection. This threshold is module dependent.
*/
void ppg_set_watch_off_threshold (INT32 ambient_threshold);

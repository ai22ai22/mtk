...
ENUM_HAL_RET_T halRTCEnterMode()
{
    ...
    if (HAL_RET_SUCCESS == ret) {
        ...
        // delay 20ms for safe power down: DE simulation is 12.xxms
        hal_gpt_delay_ms(20);
        // If after 20ms chip still have power, set PMU_EN high and return fail for enter RTC mode process
        // Enable RTC_PMU_EN

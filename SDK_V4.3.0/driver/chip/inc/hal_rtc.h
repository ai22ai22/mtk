...
/**
 * @brief This function clears the RTC retention flag, resets RTC retention SRAM configuration, and switches 32kHz clock source 
 *        from EOSC to DCXO when internal 32k mode is used after exiting from the retention mode.
 */

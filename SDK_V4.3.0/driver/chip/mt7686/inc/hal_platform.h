...
typedef enum {
    HAL_I2S_BCLK_INVERSE_DISABLE  = 0, /**< Normal mode. */
    HAL_I2S_BCLK_INVERSE_EABLE  = 1    /**< Invert BCLK. */
...
typedef enum {
    ...
    HAL_I2S_WORD_SELECT_INVERSE_EBABLE  = 1   /**< Enable the word select clock inverting.  */

...
static void i2s_xpll_open(i2s_internal_t *hal_i2s)
{
...
{
    //log_hal_info("i2s_set_initial_parameter\r\n");
    memset(hal_i2s, 0 , sizeof(i2s_internal_t));

    //hal_i2s->user_tx_callback_func = NULL;
    //hal_i2s->user_rx_callback_func = NULL;
    //hal_i2s->user_tx_data = NULL;
    //hal_i2s->user_rx_data = NULL;
    hal_i2s->i2s_state = I2S_STATE_INIT;
    hal_i2s->i2s_initial_type = HAL_I2S_TYPE_MAX;
    hal_i2s->i2s_port = HAL_I2S_0;
    hal_i2s->i2s_clock_source = HAL_I2S_CLOCK_MAX;
    //hal_i2s->i2s_vfifo.tx_vfifo_base = NULL;
    hal_i2s->i2s_vfifo.tx_vfifo_length = 0;
    hal_i2s->i2s_vfifo.tx_vfifo_threshold = 0;
    //hal_i2s->i2s_vfifo.rx_vfifo_base = NULL;
    ...
    //hal_i2s->i2s_user_config.bclk_inverse=HAL_I2S_BCLK_INVERSE_DISABLE;
    ...
    //log_hal_info("hal_i2s->i2s_user_config.bclk_inverse=%d\n", (unsigned int)hal_i2s->i2s_user_config.bclk_inverse);
...
{
    log_hal_info("i2s_set_parameter\r\n");
...
hal_i2s_status_t i2s_set_clock(i2s_internal_t *hal_i2s, hal_i2s_sample_rate_t sample_rate)
{
    ...
    //Need to read back reg value because i2s1 will modify reg itself according sampling rate settings
    ...
    */
    ...
    if (hal_i2s->i2s_port == HAL_I2S_0) {
        ...
        if (hal_i2s->i2s_clock_source == HAL_I2S_CLOCK_XO_26M) {
            //i2s1_global_cg |= (uint32_t)0x00028;

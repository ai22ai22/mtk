...
#define  ASP_DELM_PSTH_SBC_DEC  256
#define  ASP_DELM_PSTH_AAC_DEC  2048
...
#define  ASP_FRAMELEN_PSTH_SBC_DEC  ASP_DELM_PSTH_SBC_DEC
#define  ASP_FRAMELEN_PSTH_AAC_DEC  ASP_DELM_PSTH_AAC_DEC

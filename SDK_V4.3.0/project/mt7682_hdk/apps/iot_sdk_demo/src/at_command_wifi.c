...
#define LOGE(fmt,arg...)   LOG_E(WIFI_ATCMD, "ATCI iot_sdk_demo project: "fmt,##arg)
#define LOGW(fmt,arg...)   LOG_W(WIFI_ATCMD, "ATCI iot_sdk_demo project: "fmt,##arg)
#define LOGI(fmt,arg...)   LOG_I(WIFI_ATCMD, "ATCI iot_sdk_demo project: "fmt,##arg)
...
atci_status_t atci_cmd_hdlr_ip_address(atci_parse_cmd_param_t *parse_cmd)
{
    ...
    switch (parse_cmd->mode) {
        ...
        case ATCI_CMD_MODE_ACTIVE:  // rec: AT+WIFIIP
            ...
            atci_send_response(&resonse);
            break;
        case ATCI_CMD_MODE_EXECUTION: // rec: AT+WIFIIP=<sta|ap>,<set|get>,ip[<value>] the handler need to parse the parameters
            LOGI("AT Executing...\r\n");

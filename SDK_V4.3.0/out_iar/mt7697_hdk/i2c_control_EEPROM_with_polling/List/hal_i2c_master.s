...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\i2c_control_EEPROM_with_polling\List\hal_i2c_master.s
//
///////////////////////////////////////////////////////////////////////////////
...
NVIC_EnableIRQ:
        ...
        AND      R1,R0,#0x1F
        LSLS     R2,R2,R1
        LDR.W    R1,??DataTable36  ;; 0xe000e100
        LSRS     R0,R0,#+5
        STR      R2,[R1, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_DisableIRQ:
        ...
        AND      R1,R0,#0x1F
        LSLS     R2,R2,R1
        LDR.W    R1,??DataTable36_1  ;; 0xe000e180
        LSRS     R0,R0,#+5
        STR      R2,[R1, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_SetPriority:
        ...
        LDR.W    R0,??DataTable36_2  ;; 0xe000ed18
        AND      R2,R2,#0xF
        ADD      R0,R0,R2
        STRB     R1,[R0, #-4]
        B.N      ??NVIC_SetPriority_1
??NVIC_SetPriority_0:
        LDR.W    R0,??DataTable36_3  ;; 0xe000e400
        STRB     R1,[R0, R2]
??NVIC_SetPriority_1:
        ADD      SP,SP,#+4
          CFI CFA R13+0
...
??hal_i2c_master_init_1:
        ...
        MOV      R6,R4
        LDR.W    R1,??DataTable36_5
        LDRB     R2,[R1, R6]
        CMP      R2,#+1
        BNE.N    ??hal_i2c_master_init_2
        MVN      R7,#+2
        B.N      ??hal_i2c_master_init_3
...
??hal_i2c_master_send_polling_0:
        CMP      R6,#+9
        BCC.N    ??hal_i2c_master_send_polling_1
...
??hal_i2c_master_send_polling_1:
        ...
        BL       halI2CGetBusyStatus
        CMP      R0,#+1
        BNE.N    ??hal_i2c_master_send_polling_2
...
//  392     return (ret_val >= 0) ? HAL_I2C_STATUS_OK : HAL_I2C_STATUS_ERROR;
        ...
        CMP      R0,#+0
        BMI.N    ??hal_i2c_master_send_polling_3
        MOVS     R0,#+0
        POP      {R1,R4-R7,PC}
...
??hal_i2c_master_receive_polling_0:
        CMP      R6,#+9
        BCC.N    ??hal_i2c_master_receive_polling_1
...
??hal_i2c_master_receive_polling_1:
        ...
        BL       halI2CGetBusyStatus
        CMP      R0,#+1
        BNE.N    ??hal_i2c_master_receive_polling_2
...
//  426     return (ret_val >= 0) ? HAL_I2C_STATUS_OK : HAL_I2C_STATUS_ERROR;
        ...
        BL       i2c_read_via_mcu
        CMP      R0,#+0
        BMI.N    ??hal_i2c_master_receive_polling_3
        MOVS     R0,#+0
        POP      {R1,R4-R7,PC}

...
//    Command line =  
//        -f C:\Users\leo\AppData\Local\Temp\EWDA8D.tmp
//        (C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\driver\chip\mt7687\src\common\gpt.c
//        -lcN
...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\i2c_control_EEPROM_with_polling\List\gpt.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  180         current_count = DRV_Reg32(GPT0_CNT);
        ...
        LDR      R1,[R0, #+12]
        B.N      ??GPT_return_current_count_6

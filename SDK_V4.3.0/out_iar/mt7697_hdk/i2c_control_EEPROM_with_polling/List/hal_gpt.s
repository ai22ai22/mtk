...
//    Command line =  
//        -f C:\Users\leo\AppData\Local\Temp\EWDEC6.tmp
//        (C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\driver\chip\mt7687\src\hal_gpt.c
//        -lcN
...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\i2c_control_EEPROM_with_polling\List\hal_gpt.s
//
///////////////////////////////////////////////////////////////////////////////
...
??hal_gpt_get_free_run_count_4:
        ...
        BL       top_mcu_freq_get
        LDR.N    R1,??DataTable24_1  ;; 0xf4240
        UDIV     R0,R0,R1
        UDIV     R0,R6,R0
        STR      R0,[R4, #+0]
        MOVS     R0,#+1
...
//  151         return HAL_GPT_STATUS_INVALID_PARAMETER;
        MOV      R0,#-1
        B.N      ??hal_gpt_get_duration_count_1
//  152     }
//  153 
...
//  178     if (hal_gpt_is_port_valid(gpt_port) != true) {
        ...
        BL       hal_gpt_is_port_valid
        CMP      R0,#+1
        BEQ.N    ??hal_gpt_register_callback_0
...
??hal_gpt_register_callback_0:
        ...
        LDRB     R1,[R0, #+12]
        CMP      R1,#+1
        BEQ.N    ??hal_gpt_register_callback_1
...
//  220     if (hal_gpt_is_port_valid(gpt_port) != true) {
        ...
        BL       hal_gpt_is_port_valid
        CMP      R0,#+1
        BEQ.N    ??hal_gpt_start_timer_ms_0
...
??hal_gpt_start_timer_ms_0:
        ...
        LDRB     R0,[R0, #+12]
        CMP      R0,#+1
        BEQ.N    ??hal_gpt_start_timer_ms_2
...
??hal_gpt_start_timer_ms_2:
        LDR.N    R0,??DataTable24_4  ;; 0x7c1f07c
        CMP      R7,R0

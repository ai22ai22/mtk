...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\hal_adc.s
//
///////////////////////////////////////////////////////////////////////////////
...
NVIC_DisableIRQ:
        ...
        AND      R1,R0,#0x1F
        LSLS     R2,R2,R1
        LDR.W    R1,??DataTable11  ;; 0xe000e180
        LSRS     R0,R0,#+5
        STR      R2,[R1, R0, LSL #+2]
        BX       LR               ;; return
...
??halADC_Remove_Data_Offset_3:
        ...
        UXTH     R12,R12
        CMP      R12,#+4096
        BLT.N    ??halADC_Remove_Data_Offset_4
        MOVW     R12,#+4095
...
??halADC_Remove_Data_Offset_0:
        CMP      R7,R2
        BCS.N    ??halADC_Remove_Data_Offset_5
        LDR      R6,[R3, R7, LSL #+2]
        MOV      R12,R6
        UXTH     R12,R12
        LSR      R12,R12,#+4
        MOV      R8,R12
        CMP      R0,#+0
        BNE.N    ??halADC_Remove_Data_Offset_3
        SUB      R12,R12,R5
        UXTH     R12,R12
        CMP      R8,R12
        BGE.N    ??halADC_Remove_Data_Offset_4
        MOV      R12,#+0
        B.N      ??halADC_Remove_Data_Offset_4
//  538     }
//  539 }
...
// 1201             mSetHWEntry(ADC_RX_DMA_EN, 1);
        LDR.N    R0,??DataTable11_14  ;; 0x830d0004
        LDR      R1,[R0, #+72]
        ORR      R1,R1,#0x1
        STR      R1,[R0, #+72]

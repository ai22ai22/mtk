...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\ut_app_gap.s
//
///////////////////////////////////////////////////////////////////////////////
...
??bt_app_gap_io_callback_9:
        CMP      R6,#+18
        BCS.W    ??bt_app_gap_io_callback_10
        MOVS     R2,#+1
        MOV      R1,R4
        ...
        BL       strncmp
        CMP      R0,#+0
        BEQ.W    ??bt_app_gap_io_callback_10
        ADDS     R4,R4,#+1
        ADDS     R6,R6,#+1
...
??bt_app_gap_io_callback_12:
        LDRB     R0,[SP, #+0]
        CMP      R0,#+78
        BNE.N    ??bt_app_gap_io_callback_13
        MOVS     R1,#+0
        B.N      ??bt_app_gap_io_callback_14
??bt_app_gap_io_callback_13:
        MOV      R1,SP
??bt_app_gap_io_callback_14:
        LDRB     R0,[SP, #+8]
        CMP      R0,#+78
        BNE.N    ??bt_app_gap_io_callback_15
        MOVS     R0,#+0
        B.N      ??bt_app_gap_io_callback_16
...
??bt_app_gap_io_callback_4:
        ...
        BL       strncmp
        CMP      R0,#+0
        BNE.N    ??bt_app_gap_io_callback_17
        MOV      R0,R4
          CFI FunCall strlen
        BL       strlen
        CMP      R0,#+16
        BCC.N    ??bt_app_gap_io_callback_18
        ADD      R1,R4,#+16
        MOV      R0,SP
          CFI FunCall copy_str_to_addr
        BL       copy_str_to_addr
...
??bt_app_gap_io_callback_17:
        ...
        BL       strncmp
        CMP      R0,#+0
        BNE.N    ??bt_app_gap_io_callback_19
        MOV      R0,R4
          CFI FunCall strlen
        BL       strlen
        CMP      R0,#+10
        BLS.N    ??bt_app_gap_io_callback_20
        MOVS     R2,#+10
        MOVS     R1,#+0
        ADD      R0,R4,#+11
          CFI FunCall strtoul
        ...
        UXTB     R0,R0
        CMP      R0,#+0
        BEQ.N    ??bt_app_gap_io_callback_21
        UXTB     R5,R5
        CMP      R5,#+1
        BEQ.N    ??bt_app_gap_io_callback_21
        ADR.W    R0,?_13
...
??bt_app_gap_io_callback_19:
        ...
        BL       strncmp
        CMP      R0,#+0
        BNE.N    ??bt_app_gap_io_callback_22
        MOV      R0,R4
          CFI FunCall strlen
        BL       strlen
        CMP      R0,#+13
        BLS.N    ??bt_app_gap_io_callback_23
        MOVS     R2,#+10
        MOVS     R1,#+0
        ADD      R0,R4,#+14
          CFI FunCall strtoul
        ...
        UXTB     R0,R0
        CMP      R0,#+0
        BEQ.N    ??bt_app_gap_io_callback_24
        UXTB     R5,R5
        CMP      R5,#+1
        BEQ.N    ??bt_app_gap_io_callback_24
        ADR.W    R0,?_13
...
??bt_app_gap_io_callback_22:
        ...
        BL       strncmp
        CMP      R0,#+0
        BNE.N    ??bt_app_gap_io_callback_25
        MOVS     R1,#+0
        MOVW     R0,#+8208
          CFI FunCall bt_gap_le_set_white_list
        BL       bt_gap_le_set_white_list
...
??bt_app_gap_io_callback_25:
        ...
        BL       strlen
        CMP      R0,#+16
        BLS.W    ??bt_app_gap_io_callback_1
        ADD      R0,R4,#+17
          CFI FunCall strlen
        BL       strlen
        MOV      R2,R0
...
??bt_app_gap_io_callback_41:
        ...
        MOVW     R0,#+3841
        CMP      R1,R0
        BGE.N    ??bt_app_gap_io_callback_43
        LDRH     R2,[SP, #+2]
        SUB      R0,R2,#+27
        CMP      R0,#+225
        BCS.N    ??bt_app_gap_io_callback_43
        LDRH     R3,[SP, #+4]
        SUB      R0,R3,#+328
        MOVW     R4,#+1793
        CMP      R0,R4
        BCC.N    ??bt_app_gap_io_callback_44
...
??bt_app_gap_io_callback_42:
        ...
        BL       strncmp
        CMP      R0,#+0
        BNE.N    ??bt_app_gap_io_callback_45
        MOVS     R2,#+16
        MOVS     R1,#+0
        ADD      R0,R4,#+13
          CFI FunCall strtoul
        ...
        MOVW     R0,#+3841
        CMP      R1,R0
        BGE.N    ??bt_app_gap_io_callback_46
        LDRH     R2,[SP, #+2]
        CMP      R2,#+8
        BLT.N    ??bt_app_gap_io_callback_47
...
??bt_app_gap_io_callback_45:
        ...
        BL       strncmp
        CMP      R0,#+0
        BNE.N    ??bt_app_gap_io_callback_48
        LDR.N    R5,??DataTable57_15
        MOVS     R2,#+10
        MOVS     R1,#+0
        ADD      R0,R4,#+14
          CFI FunCall strtoul
...
??bt_app_gap_io_callback_10:
        ...
        BL       strncmp
        CMP      R0,#+0
        BEQ.W    ??bt_app_gap_io_callback_11
        MOV      R1,R4
        MOV      R0,SP
          CFI FunCall copy_str_to_addr
        BL       copy_str_to_addr
        B.W      ??bt_app_gap_io_callback_12
//  484 }

...
//    Endian       =  little
//    Source file  =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\middleware\MTK\bluetooth\src\bt_task.c
//    Command line =  
//        -f C:\Users\leo\AppData\Local\Temp\EW5329.tmp
//        (C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\middleware\MTK\bluetooth\src\bt_task.c
...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\bt_task.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  135 	if( 0 == HAL_NVIC_QUERY_EXCEPTION_NUMBER)
        LDR.N    R1,??DataTable7_3  ;; 0xe000ed04
        LDR      R1,[R1, #+0]
        LSLS     R1,R1,#+23

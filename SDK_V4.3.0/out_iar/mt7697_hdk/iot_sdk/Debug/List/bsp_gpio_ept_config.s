...
//    Endian       =  little
//    Source file  =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\driver\board\mt76x7_hdk\ept\src\bsp_gpio_ept_config.c
//    Command line =  
//        -f C:\Users\leo\AppData\Local\Temp\EW4E4F.tmp
//        (C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\driver\board\mt76x7_hdk\ept\src\bsp_gpio_ept_config.c
...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\bsp_gpio_ept_config.s
//
///////////////////////////////////////////////////////////////////////////////
...
??gpio_ies_init_1:
        MOV      R1,SP
        LDR      R1,[R1, R0, LSL #+2]
        LDR.N    R2,??DataTable11_2  ;; 0x8300b100
        ADD      R2,R2,R0, LSL #+2
        STR      R1,[R2, #+0]
//  142     }
        ADDS     R0,R0,#+1
??gpio_ies_init_0:
        CMP      R0,#+2
        BLS.N    ??gpio_ies_init_1
//  143 
//  144     /* Configure GPIO27 */
//  145     GPIO_ReadReg(GPIO_SDIO_CLK) &= ~(0x2);
        LDR.N    R0,??DataTable11_3  ;; 0x81023048
        LDR      R1,[R0, #+0]
        BIC      R1,R1,#0x2
        STR      R1,[R0, #+0]
...
??gpio_pull_up_init_1:
        MOV      R1,SP
        LDR      R1,[R1, R0, LSL #+2]
        LDR.N    R2,??DataTable11_4  ;; 0x8300b000
        ADD      R2,R2,R0, LSL #+4
        STR      R1,[R2, #+0]
//  191     }
        ADDS     R0,R0,#+1
...
??gpio_pull_down_init_1:
        MOV      R1,SP
        LDR      R1,[R1, R0, LSL #+2]
        LDR.N    R2,??DataTable11_5  ;; 0x8300b030
        ADD      R2,R2,R0, LSL #+4
        STR      R1,[R2, #+0]
//  259     }
        ADDS     R0,R0,#+1
...
??gpio_output_init_1:
        MOV      R1,SP
        LDR      R1,[R1, R0, LSL #+2]
        LDR.N    R2,??DataTable11_6  ;; 0x8300b060
        ADD      R2,R2,R0, LSL #+4
        STR      R1,[R2, #+0]
//  278     }
        ADDS     R0,R0,#+1

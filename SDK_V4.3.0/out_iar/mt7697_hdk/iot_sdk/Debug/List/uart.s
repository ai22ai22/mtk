...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\uart.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  205             *length = DMA_GetVFIFO_Avail(VDMA_UART1RX_CH);
        LDR.W    R0,??DataTable22_5  ;; 0x83010f38
        LDRH     R0,[R0, #+0]
        STR      R0,[R2, #+0]
        BX       LR
//  206         } else {
...
??halUART_Get_VFIFO_Length_1:
        LDR.W    R0,??DataTable22_6  ;; 0x83010e38
        LDRH     R1,[R0, #+12]
        STR      R1,[R2, #+0]
...
//  212             *length = DMA_GetVFIFO_Avail(VDMA_UART2RX_CH);
        LDR.W    R0,??DataTable22_7  ;; 0x83011138
        LDRH     R0,[R0, #+0]
        STR      R0,[R2, #+0]
        BX       LR
//  213         } else {

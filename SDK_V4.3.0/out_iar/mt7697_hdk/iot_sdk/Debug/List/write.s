...
//        8.0_2\arm\src\lib\file\write.c
//    Command line =  
//        -f C:\Users\leo\AppData\Local\Temp\EWD1DA.tmp ("C:\Program Files
//        (x86)\IAR Systems\Embedded Workbench 8.0_2\arm\src\lib\file\write.c"
...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\write.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Program Files (x86)\IAR Systems\Embedded Workbench 8.0_2\arm\src\lib\file\write.c
//    1 /*******************
//    2  *
...
//   21  ********************/
//   22 
//   23 #include <LowLevelIOInterface.h>
//   24 
//   25 #pragma module_name = "?__write"
//   26 
//   27 int MyLowLevelPutchar(int x);
//   28 
//   29 /*
//   30  * If the __write implementation uses internal buffering, uncomment
//   31  * the following line to ensure that we are called with "buffer" as 0
//   32  * (i.e. flush) when the application terminates.
//   33  */
//   34 
...
//   43   {
//   44     /*
//   45      * This means that we should flush internal buffers.  Since we
//   46      * don't we just return.  (Remember, "handle" == -1 means that all
//   47      * handles should be flushed.)
//   48      */
//   49     return 0;
//   50   }
//   51 
//   52   /* This template only writes to "standard out" and "standard err",
//   53    * for all other file handles it returns failure. */
//   54   if (handle != _LLIO_STDOUT && handle != _LLIO_STDERR)
//   55   {
//   56     return _LLIO_ERROR;
//   57   }
//   58 
//   59   for (/* Empty */; size != 0; --size)
//   60   {
//   61     if (MyLowLevelPutchar(*buffer++) < 0)
//   62     {
...
//   71 #else
//   72 
//   73   /* Always return error code when implementation is disabled. */
//   74   return _LLIO_ERROR;
__write:
        MOV      R0,#-1
        BX       LR               ;; return
//   75 

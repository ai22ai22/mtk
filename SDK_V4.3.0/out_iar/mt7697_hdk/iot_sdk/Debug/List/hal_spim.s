...
//    Endian       =  little
//    Source file  =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\driver\chip\mt7687\src\common\hal_spim.c
//    Command line =  
//        -f C:\Users\leo\AppData\Local\Temp\EW7B2B.tmp
//        (C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\driver\chip\mt7687\src\common\hal_spim.c
...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\hal_spim.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   96     spi_reg_and(SPI_REG_MASTER, ~0xEFFF067B);
        LDR.N    R1,??DataTable5_8  ;; 0x24000028
        LDR      R2,[R1, #+0]
        LDR.N    R0,??DataTable5_9  ;; 0x1000f984
        ANDS     R2,R0,R2
        STR      R2,[R1, #+0]
...
??spim_busy_wait_0:
        ...
        LDR      R1,[R1, #+0]
        LSLS     R1,R1,#+15
        BPL.N    ??spim_busy_wait_1
//  108             return 0;
//  109         }
//  110     } while (--n > 0);
        SUBS     R0,R0,#+1
        CMP      R0,#+0
        BGT.N    ??spim_busy_wait_0
//  111 
//  112     //printf("%s: fail \n", __func__);
//  113     return -1;
        MOV      R0,#-1
...
??spim_more_buf_trans_gpio_1:
        LDR.N    R3,??DataTable5_10  ;; 0x24000008
        ADD      R3,R3,R0, LSL #+2
        STR      R1,[R3, #+0]
//  131     }
        ADDS     R0,R0,#+1
...
//  141             r = i % 4;
        SUBS     R0,R1,R3, LSL #+2
//  142             if (r == 0) {
        LDR.N    R2,??DataTable5_10  ;; 0x24000008
        ADDS     R2,R2,R3, LSL #+2
        CMP      R0,#+0
...
??spim_more_buf_trans_gpio_2:
        LDR      R1,[R6, #+44]
        LDR.N    R0,??DataTable5_11  ;; 0xffe00e00
        ANDS     R1,R0,R1
        STR      R1,[R6, #+44]
...
??spim_more_buf_trans_gpio_8:
        MOVS     R0,#+1
        LDR.N    R1,??DataTable5_12  ;; 0x8300b078
        STR      R0,[R1, #+0]

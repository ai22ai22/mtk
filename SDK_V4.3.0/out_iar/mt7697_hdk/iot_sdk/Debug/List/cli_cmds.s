...
//    Endian       =  little
//    Source file  =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\project\mt7697_hdk\apps\iot_sdk\src\cli_cmds.c
//    Command line =  
//        -f C:\Users\leo\AppData\Local\Temp\EW55ED.tmp
//        (C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\project\mt7697_hdk\apps\iot_sdk\src\cli_cmds.c
...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\cli_cmds.s
//
///////////////////////////////////////////////////////////////////////////////
...
_cli_ptr:
        ...
        DC32 connsys_cli_entry
        DC8 0, 0, 0, 0
        DC32 ?_8, ?_9, lwip_ip_cli, 0H, ?_10, ?_11, _show_lwip_stat
        DC8 0, 0, 0, 0
        DC32 ?_12, ?_13, 0H, wifi_private_cli, ?_14, ?_15, board_cli_reg_read
        DC32 0H, ?_16, ?_17, board_cli_reg_write, 0H, ?_18, ?_19, 0H, lp_cli
        DC32 ?_20, ?_20, board_cli_reboot
        DC8 0, 0, 0, 0
        DC32 ?_21, ?_22, wifi_config_set_n9log_state_ex
        DC8 0, 0, 0, 0
        DC32 0H, 0H, 0H, 0H
        DC32 ?_23, ?_24, _sdk_cli_test_mode
        DC8 0, 0, 0, 0
        DC32 ?_8, ?_9, lwip_ip_cli, 0H, ?_10, ?_11, _show_lwip_stat
        DC8 0, 0, 0, 0
        DC32 ?_25, ?_26, ping_cli_handler, 0H, ?_27, ?_27, 0H, iperf_cli, ?_28
        DC32 ?_29, 0H, nvdm_cli_cmds, ?_12, ?_30, 0H, wifi_pub_cli, ?_31, ?_32
        DC32 _smart_config_test
        DC8 0, 0, 0, 0
        DC32 ?_33, ?_34, bt_cli_ble
        DC8 0, 0, 0, 0
        DC32 ?_35, ?_36, bt_cli_bqb
        DC8 0, 0, 0, 0
        DC32 ?_37, ?_38, syslog_cli_show_config, syslog_cli, ?_20, ?_20
        DC32 board_cli_reboot
        DC8 0, 0, 0, 0
        DC32 ?_39, ?_40, board_cli_ver
        DC8 0, 0, 0, 0
        DC32 0H, 0H, 0H, 0H
//   48 
//   49 

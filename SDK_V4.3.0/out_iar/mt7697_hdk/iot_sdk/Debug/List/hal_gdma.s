...
//    Endian       =  little
//    Source file  =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\driver\chip\mt7687\src\hal_gdma.c
//    Command line =  
//        -f C:\Users\leo\AppData\Local\Temp\EW6E42.tmp
//        (C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\driver\chip\mt7687\src\hal_gdma.c -D
...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\hal_gdma.s
//
///////////////////////////////////////////////////////////////////////////////
...
??hal_gdma_start_polling_6:
        ADDS     R0,R6,#+1
        LDR.N    R1,??DataTable21_3  ;; 0x83010000
        MOVS     R2,#+1
        CMP      R0,#+17
...
??hal_gdma_get_running_status_0:
        ADDS     R6,R6,#+1
        LDR.N    R0,??DataTable21_3  ;; 0x83010000
        MOVS     R1,#+1
        CMP      R6,#+17

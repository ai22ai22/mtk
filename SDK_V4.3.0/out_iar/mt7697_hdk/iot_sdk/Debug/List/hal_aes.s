...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\hal_aes.s
//
///////////////////////////////////////////////////////////////////////////////
...
NVIC_EnableIRQ:
        ...
        AND      R1,R0,#0x1F
        LSLS     R2,R2,R1
        LDR.W    R1,??DataTable31_2  ;; 0xe000e100
        LSRS     R0,R0,#+5
        STR      R2,[R1, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_DisableIRQ:
        ...
        AND      R1,R0,#0x1F
        LSLS     R2,R2,R1
        LDR.W    R1,??DataTable31_3  ;; 0xe000e180
        LSRS     R0,R0,#+5
        STR      R2,[R1, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_ClearPendingIRQ:
        ...
        AND      R1,R0,#0x1F
        LSLS     R2,R2,R1
        LDR.W    R1,??DataTable31_4  ;; 0xe000e280
        LSRS     R0,R0,#+5
        STR      R2,[R1, R0, LSL #+2]
        BX       LR               ;; return
...
//  107         if (wait_count > HAL_AES_MAX_WAIT_COUNT) {
        LDR.N    R0,??DataTable31_9  ;; 0x10000001
        CMP      R1,R0
        BCC.N    ??do_aes_encrypt_1
...
//  286     log_hal_dump("Decrypted raw data(AES %s): ", plain_text->buffer, encrypted_text->length, (mode == AES_TYPE_CBC) ? "CBC" : "ECB");
        CMP      R8,#+1
        BNE.N    ??hal_aes_decrypt_9
        ADR.N    R1,??DataTable31  ;; "CBC"
        B.N      ??hal_aes_decrypt_10
??hal_aes_decrypt_9:

...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\hal_i2s_internal.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  148         DRV_Reg32(DMA_CVFF(VDMA_I2S_TX_CH)) = VFIFO_base | ((TxCasPortAddr - DMA_VFIFO_CH_S) << 8) | DMA_CVFF_CVFF_EN;
        SUBS     R2,R2,#+12
        LDR.W    R0,??DataTable20_1  ;; 0x79000001
        ORR      R0,R0,R2, LSL #+8
        STR      R0,[R4, #+28]
...
??I2sVdmaRxStart_0:
        LDR.W    R4,??DataTable20_2  ;; 0x83010d2c
        STR      R0,[R4, #+0]
...
//  188     u4DmaCon = DRV_Reg32(DMA_CON(VDMA_I2S_TX_CH));
        LDR.W    R4,??DataTable20_3  ;; 0x83010c14
        LDR      R5,[R4, #+0]
//  189 
...
//  207     u4DmaCon = DRV_Reg32(DMA_CON(VDMA_I2S_RX_CH));
        LDR.W    R4,??DataTable20_4  ;; 0x83010d14
        LDR      R5,[R4, #+0]
//  208 
...
I2sSetVdmaTxThreshold:
        LDR.W    R1,??DataTable20_5  ;; 0x83010c10
        STR      R0,[R1, #+0]
//  239 
//  240     return KAL_TRUE;
        MOVS     R0,#+1
...
I2sSetVdmaRxThreshold:
        LDR.W    R1,??DataTable20_6  ;; 0x83010d10
        STR      R0,[R1, #+0]
//  246 
//  247     return KAL_TRUE;
        MOVS     R0,#+1
...
I2sReadVdmaRxFifo:
        LDR.W    R1,??DataTable20_7  ;; 0x79000100
        LDR      R1,[R1, #+0]
        STR      R1,[R0, #+0]
//  260 
//  261     return KAL_TRUE;
...
I2sGetVdmaTxFifoCnt:
        LDR.W    R0,??DataTable20_8  ;; 0x83010c38
        LDRH     R0,[R0, #+0]
        BX       LR               ;; return
//  267 }
...
I2sGetVdmaRxFifoCnt:
        LDR.W    R0,??DataTable20_9  ;; 0x83010d38
        LDRH     R0,[R0, #+0]
        BX       LR               ;; return
//  272 }
...
??I2sSetGblCfg_17:
        LDR.W    R0,??DataTable20_10  ;; 0x830b0000
        STR      R1,[R0, #+0]
//  371 
//  372     return KAL_TRUE;
        MOVS     R0,#+1
...
??I2sSetDlCfg_14:
        ORR      R1,R1,#0x8000
        LDR.W    R0,??DataTable20_11  ;; 0x830b0004
        STR      R1,[R0, #+0]
//  458 
//  459     return KAL_TRUE;
        MOVS     R0,#+1
...
??I2sSetUlCfg_16:
        ORR      R1,R1,#0x8000
        LDR.N    R0,??DataTable20_12  ;; 0x830b0008
        STR      R1,[R0, #+0]
//  555 
//  556     //dump register
//  557     /*
...
I2sClkFifoEn:
        LDR.N    R1,??DataTable20_10  ;; 0x830b0000
        CMP      R0,#+1
        LDR      R0,[R1, #+0]
...
I2sDlEn:
        LDR.N    R1,??DataTable20_11  ;; 0x830b0004
        CMP      R0,#+1
        LDR      R0,[R1, #+0]
        BNE.N    ??I2sDlEn_0
//  599 
...
I2sUlEn:
        LDR.N    R1,??DataTable20_12  ;; 0x830b0008
        CMP      R0,#+1
        LDR      R0,[R1, #+0]
        BNE.N    ??I2sUlEn_0
//  617 
...
I2sReset:
        LDR.N    R0,??DataTable20_13  ;; 0x830b000c
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x1
        STR      R1,[R0, #+0]
...
//  787     HAL_REG_32(0x81021028) |= 0x600000;
        LDR.N    R0,??DataTable20_15  ;; 0x81021028
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x600000
        STR      R1,[R0, #+0]
//  788 
...
//  790     if (xtal_freq == 26000000) {
        LDR.N    R1,??DataTable20_16  ;; 0x18cba80
        CMP      R0,R1
        BNE.N    ??xpllOpen_0
...
//  793                                 RG_XPLL_PREDIV_1 | RG_XPLL_FBDIV(0xF) | RG_XPLL_PWD;//0x0000741F
        LDR.N    R4,??DataTable20_17  ;; 0x81021280
        MOVW     R0,#+29727
        STR      R0,[R4, #+0]
...
??xpllOpen_0:
        LDR.N    R1,??DataTable20_18  ;; 0x2625a00
        CMP      R0,R1
        BNE.N    ??xpllOpen_2
...
//  820         HAL_REG_32(XPLL_CTL3) = 0x12CC0000;
        LDR.N    R0,??DataTable20_19  ;; 0x12cc0000
        STR      R0,[R4, #+12]
...
//  830         HAL_REG_32(XPLL_CTL8) = 0x2FC08;
        LDR.N    R0,??DataTable20_20  ;; 0x2fc08
        STR      R0,[R4, #+32]
//  831 
...
//  834         HAL_REG_32(XPLL_CTL8) = 0x2FC18;
        LDR.N    R0,??DataTable20_21  ;; 0x2fc18
        STR      R0,[R4, #+32]
//  835 
...
//  838         HAL_REG_32(XPLL_CTL3) = 0x12CC0001;
        LDR.N    R0,??DataTable20_22  ;; 0x12cc0001
        STR      R0,[R4, #+12]
//  839 
...
//  842         HAL_REG_32(XPLL_CTL8) = 0x2FC38;
        LDR.N    R0,??DataTable20_23  ;; 0x2fc38
        STR      R0,[R4, #+32]
//  843 
...
//  856     u4Reg = HAL_REG_32(RG_PMU_14);
        LDR.N    R0,??DataTable20_24  ;; 0x81021438
        LDR      R1,[R0, #+0]
...
//  862     HAL_REG_32(AUDDEC_CON9) = 0;
        LDR.N    R0,??DataTable20_25  ;; 0x830b2524
        MOVS     R1,#+0
        STR      R1,[R0, #+0]
...
xpllClose:
        MOVS     R0,#+1
        LDR.N    R1,??DataTable20_26  ;; 0x830b252c
        STR      R0,[R1, #+0]
...
//  891     HAL_REG_32(XPLL_CTL8) = RG_XPLL_BIAS_PWD | RG_XPLL_RESERVE(0xF0) | RG_XPLL_FIFO_START_MAN | RG_XPLL_DDS_RSTB_MASK;//0x0001F030;
        LDR.N    R1,??DataTable20_27  ;; 0x1f030
        STR      R1,[R0, #+32]
//  892 

...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\dns.s
//
///////////////////////////////////////////////////////////////////////////////
...
??dns_alloc_pcb_0:
        ...
        MOV      R6,R5
        CMP      R6,#+4
        BGE.N    ??dns_alloc_pcb_1
//  903     if (dns_pcbs[i] == NULL) {
        ADD      R0,R4,R6, LSL #+2
        LDR      R0,[R0, #+12]
        CMP      R0,#+0
        BEQ.N    ??dns_alloc_pcb_1
//  904       break;
//  905     }
//  906   }
        ADDS     R5,R5,#+1
...
??dns_alloc_pcb_3:
        UXTB     R2,R2
        CMP      R2,#+4
        BGE.N    ??dns_alloc_pcb_5
//  919     if (idx >= DNS_MAX_SOURCE_PORTS) {
        CMP      R0,#+4
        BLT.N    ??dns_alloc_pcb_6
//  920       idx = 0;
        MOVS     R0,#+0
//  921     }
...
??dns_recv_4:
        ...
        BL       lwip_ntohl
        STR      R0,[R6, #+0]
        LDR.N    R1,??DataTable21_5  ;; 0x93a80
        CMP      R0,R1
        BLS.N    ??dns_recv_6
        STR      R1,[R6, #+0]
??dns_recv_6:
...
??dns_enqueue_11:
        ...
        MOV      R0,R1
        CMP      R0,#+4
        BGE.N    ??dns_enqueue_13
// 1417     if (dns_requests[r].found == NULL) {
        MOVS     R2,#+12
        SMULBB   R2,R2,R0
        LDR      R0,[R3, R2]
        CMP      R0,#+0
        BNE.N    ??dns_enqueue_12
...
// 1528     ip_addr_set_loopback(LWIP_DNS_ADDRTYPE_IS_IPV6(dns_addrtype), addr);
        LDR.N    R0,??DataTable21_7  ;; 0x100007f
        STR      R0,[R4, #+0]
// 1529     return ERR_OK;
        MOVS     R0,#+0
        B.N      ??dns_gethostbyname_2

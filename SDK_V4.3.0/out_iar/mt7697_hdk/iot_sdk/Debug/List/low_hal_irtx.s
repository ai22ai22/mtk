...
//    Locale       =  C
//    List file    =  
//        C:\LEO\myGit\MTK-IOT\SDK_V4.3.0\out_iar\mt7697_hdk\iot_sdk\Debug\List\low_hal_irtx.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  137     u4Val = pIRTXTypeDef->IRTXCFG;
        LDR.N    R3,??DataTable5  ;; 0x83060000
        LDR      R4,[R3, #+0]
//  138 
...
??halIrTxConfig_0:
        LDR.N    R4,??DataTable5  ;; 0x83060000
        LDR      R9,[R4, #+0]
//  210 
//  211     // IR N inverter
//  212     // value 0
...
??halIrTxSend_0:
        LDR.N    R5,??DataTable5  ;; 0x83060000
        LDR      R4,[R5, #+0]
        UBFX     R4,R4,#+1,#+3
//  377 
...
halIrTxClearInterrupt:
        LDR.N    R0,??DataTable5_1  ;; 0x8306002c
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x1
        STR      R1,[R0, #+0]
//  490 }

...
static void bt_sink_srv_hf_sco_disconnect_callback(void *parameter)
{
    bt_hfp_audio_transfer(((bt_sink_srv_hf_context_t *)parameter)->handle, BT_HFP_AUDIO_TO_AG);
}

static void bt_sink_srv_hf_sco_disconnect(bt_sink_srv_hf_context_t *bt_sink_srv_hf_context_p)
{
    bt_sink_srv_timer_start(BT_SINK_SRV_TIMER_HF_AUDIO_DISC,
                            BT_SINK_SRV_HF_AUDIO_DISC_DURATION,
                            bt_sink_srv_hf_sco_disconnect_callback,
    ...
    if (bt_sink_srv_hf_audio_get_audio_id(BT_SINK_SRV_HF_AUDIO_CALL, &current_id)) {
        if (BT_SINK_SRV_HF_AUDIO_CALL == audio_type) {
            ...
            if (bt_sink_srv_hf_context_p == bt_sink_srv_hf_get_highlight_device()) {
                ...
                if (BT_SINK_SRV_HF_AUDIO_SCO == audio_type) {
#ifndef __BT_SINK_SRV_DUAL_SCO_SUPPORT__
                    bt_sink_srv_hf_sco_disconnect(bt_sink_srv_hf_context_p);
#endif /* __BT_SINK_SRV_DUAL_SCO_SUPPORT__ */
                }
            }
        }
        ...
        case BT_HFP_AUDIO_CONNECT_IND: {
            ...
            if (NULL != bt_sink_srv_hf_p) {
                ...
                if (NULL != bt_sink_srv_hf_context_p) {
                    ...
                    bt_sink_srv_timer_stop(BT_SINK_SRV_TIMER_HF_AUDIO_CONN);

    ...
    hal_audio_sampling_rate_t sampling_rate)
{
    ...
    switch (sampling_rate) 
    {
        ...
        case HAL_AUDIO_SAMPLING_RATE_11_025KHZ: /**< 11025Hz */
        {
        ...
        case HAL_AUDIO_SAMPLING_RATE_16KHZ: /**< 16000Hz */
        {
            sampling_rate_value = 16000;
            break;
        }
        case HAL_AUDIO_SAMPLING_RATE_22_05KHZ: /**< 22050Hz */
        {
            sampling_rate_value = 22050;
            break;
        }
        case HAL_AUDIO_SAMPLING_RATE_24KHZ: /**< 24000Hz */
        {
            sampling_rate_value = 24000;
            break;
        }
        case HAL_AUDIO_SAMPLING_RATE_32KHZ: /**< 32000Hz */
        {
            sampling_rate_value = 32000;
            break;
        }
        case HAL_AUDIO_SAMPLING_RATE_44_1KHZ: /**< 44100Hz */
        {
            sampling_rate_value = 44100;
            break;
        }
        case HAL_AUDIO_SAMPLING_RATE_48KHZ: /**< 48000Hz */
        {
            sampling_rate_value = 48000;
            break;
        }
        case HAL_AUDIO_SAMPLING_RATE_96KHZ: /**< 96000Hz */
        {
            sampling_rate_value = 96000;
            break;
        }
        default:
        {
            bt_sink_srv_report("sampling rate error!!!");
            return BT_STATUS_FAIL;
        }
    }
    uint64_t bt_sample = (bt_a2dp_audio_sync_hdl.total_bt_clock * (uint64_t)sampling_rate_value)/1000000/2;

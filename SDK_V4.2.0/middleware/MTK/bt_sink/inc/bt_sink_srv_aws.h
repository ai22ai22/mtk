...
int32_t bt_sink_srv_aws_play_music(uint32_t handle);

int32_t bt_sink_srv_aws_stop_music(uint32_t handle);

int32_t bt_sink_srv_aws_change_ntrack(uint32_t handle);

int32_t bt_sink_srv_aws_change_ptrack(uint32_t handle);

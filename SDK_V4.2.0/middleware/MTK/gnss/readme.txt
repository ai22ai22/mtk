...
Notice:         For GCC, keep the copy_firmware.sh statement in the Makefile under GCC folder in a project to copy GNSS firmware image.
                For KEIL and IAR, users need to download GNSS firmware image to target device manually by flashing image middleware/MTK/gnss/firmware/gnss_chip_fw.bin with MediaTek Flashtool.

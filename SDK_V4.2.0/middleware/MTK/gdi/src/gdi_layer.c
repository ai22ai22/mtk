...
GDI_LOG("[GDI_LAYER]BSP_LCD_ConfigROI (%d, %d, %d, %d)\n", x1, y1, x2, y2);
    BSP_LCD_ConfigROI(&lcd_para);
...
GDI_LOG("[GDI_LAYER]Begin to BSP_LCD_UpdateScreen [%d, %d, %d, %d]\n", lcd_para.target_start_x , lcd_para.target_start_y ,lcd_para.target_end_x, lcd_para.target_end_y);
	BSP_LCD_UpdateScreen(lcd_para.target_start_x , lcd_para.target_start_y ,lcd_para.target_end_x, lcd_para.target_end_y);
	return GDI_SUCCEED;
}

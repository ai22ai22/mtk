...
extern kal_uint16 USB2UART_GetRxAvail(uint8_t port);
extern kal_uint16 USB2UART_GetBufAvail(BUFFER_INFO *buf_info);
extern kal_uint16 USB2UART_GetBytes(uint8_t port, kal_uint8 *buffaddr, kal_uint16 length);
extern void USB2UART_ClrTxBuffer(uint8_t port);
extern kal_uint16 USB2UART_GetTxRoomLeft(uint8_t port);
extern kal_uint16 USB2UART_PutBytes(uint8_t port, kal_uint8 *buffaddr, kal_uint16 length);
extern kal_uint8 USB2UART_GetByte_Polling(uint8_t port);
extern void USB2UART_PutData_Polling(uint8_t port, kal_uint8 *Buffaddr, kal_uint16 Length);

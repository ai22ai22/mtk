...
typedef void (*UART_TX_FUNC)(kal_uint32 port); 
typedef void (*UART_RX_FUNC)(kal_uint32 port) ; 
...
#ifdef MTK_PORT_SERVICE_ENABLE
extern kal_uint8 USB_PORT[SERIAL_PORT_DEV_MAX];
#else
extern kal_uint8 USB_PORT[2];
#endif
...
extern void USB_UnMask_COM_Intr(kal_uint32 port);
...
extern void USB2UART_Dafault_Tx_Callback(kal_uint32 port);
extern void USB2UART_Dafault_Rx_Callback(kal_uint32 port);
extern void USB2UART_DMATransmit(kal_uint32 port);

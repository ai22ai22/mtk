...
Usage:          GCC:  For EDR/BLE stack, include the module with 
                ...
                KEIL: For EDR/BLE stack, 
                      1)Add the following libs, libbt_CM4_keil.lib and libbtdriver_2523_CM4_keil.lib are mandatory, but profile libs are optional:
                        middleware/MTK/bluetooth/lib/libbt_CM4_keil.lib
                        middleware/MTK/bluetooth/lib/libbtdriver_2523_CM4_keil.lib
                        middleware/MTK/bluetooth/lib/libbt_spp_CM4_keil.lib
                        middleware/MTK/bluetooth/lib/libbt_pbapc_CM4_keil.lib
                        middleware/MTK/bluetooth/lib/libbt_hfp_CM4_keil.lib
                        middleware/MTK/bluetooth/lib/libbt_avrcp_eh_CM4_keil.lib
                        middleware/MTK/bluetooth/lib/libbt_avrcp_CM4_keil.lib
                        middleware/MTK/bluetooth/lib/libbt_a2dp_CM4_keil.lib
                      2)add all source files except bt_cli.c under the path "middleware/MTK/bluetooth/src" to your project 
                      3)add the path "..\..\..\..\..\middleware\MTK\bluetooth\inc" to the "include paths" of the C/C++ options.
                      ...
                      1)add these two libraries to your project:
                        middleware/MTK/bluetooth/lib/libble_CM4_keil.lib
                        middleware/MTK/bluetooth/lib/libbtdriver_7697_CM4_keil.lib
                ...
                IAR:  For EDR/BLE stack, 
                      1)Add the following libs, libbt_iar.a and libbtdriver_2523_iar.a are mandatory, but profile libs are optional:
                        middleware/MTK/bluetooth/lib/libbt_iar.a
                        middleware/MTK/bluetooth/lib/libbt_driver_2523_iar.a
                        middleware/MTK/bluetooth/lib/libbt_spp_iar.a
                        middleware/MTK/bluetooth/lib/libbt_pbapc_iar.a
                        middleware/MTK/bluetooth/lib/libbt_hfp_iar.a
                        middleware/MTK/bluetooth/lib/libbt_avrcp_iar.a
                        middleware/MTK/bluetooth/lib/libbt_avrcp_enhance_iar.a
                        middleware/MTK/bluetooth/lib/libbt_a2dp_iar.a
                      2)add all source files except bt_cli.c under the path "middleware/MTK/bluetooth/src" to your project 
                      3)add the path "$PROJ_DIR$\..\..\..\..\..\middleware\MTK\bluetooth\inc" to the "Additional include directories" of the preprocessor.
                      4)copy the hci_log.h to the [project]/inc folder and hci_log.c to the [project]/src folder from the 
                        project folder with bt_ or ble_ prefix. 
                        Add the source file hci_log.c to your project.
                      ...
                      For BLE only stack, 
                      1)add these two libraries to your project:
                        middleware/MTK/bluetooth/lib/libble_iar.a
                        middleware/MTK/bluetooth/lib/libbtdriver_7697_iar.a
                      2)add all source files under the path "middleware/MTK/bluetooth/src" to your project 
                      3)add the path "$PROJ_DIR$\..\..\..\..\..\middleware\MTK\bluetooth\inc" to the "Additional include directories" of the preprocessor.
                      4)copy the hci_log.h to the [project]/inc folder and hci_log.c to the [project]/src folder from the iot_sdk project.
                      Add the source file hci_log.c to your project.

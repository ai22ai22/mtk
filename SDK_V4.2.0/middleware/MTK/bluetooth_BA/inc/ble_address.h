...
/**
 * @defgroup BA_Bluetoothble_address_enum Enum
 * @{
 */

/**
 * @deprecated This enumeration defines the BLE device address type.
 */
typedef enum {
...
/**
 * @defgroup BA_Bluetoothble_address_struct Struct
 * @{
 */

/** @deprecated This structure defines the BLE device address. */
typedef struct {

 ...
 * @{
 * @addtogroup BA_BluetoothBTGAP GAP
 * @{
...
/** @defgroup BA_Bluetoothbt_gap_define Define
  * @{
  */

/**
 *  @deprecated The maximum length of the Bluetooth device's name.
 */
#define BT_GAP_MAX_NAME_LEN 80

/**
 *  @deprecated The length of Link Key.
 */
...
/** @defgroup BA_Bluetoothbt_gap_enum Enum
  * @{
  */

/**
 *  @deprecated Device roles in a piconet.
 */
typedef enum {
...
/**
 *  @deprecated Connection link types.
 */
typedef enum {
...
/**
 *  @deprecated Encryption status for the connection.
 */
typedef enum {
...
/**
 *  @deprecated Input and output capabilities.
 */
typedef enum {
...
/**
 *  @deprecated Class of Device/Service.
 */
typedef enum {
...
/**
 *  @deprecated Reason for ending the connection.
 */
typedef enum {
...
/** @defgroup BA_Bluetoothbt_gap_typedef Typedef
  * @{
  */

/**
 *  @deprecated This type defines a parameter of the #BT_GAP_USER_CONFIRM_REQUEST_IND event.
 */
typedef bt_address_t bt_gap_user_confirm_request_ind_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_IO_CAPABILITY_REQUEST_IND event.
 */
typedef bt_address_t bt_gap_io_capability_request_ind_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_PIN_CODE_REQUEST_IND event.
 */
typedef bt_address_t bt_gap_pin_code_request_ind_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_SEND_KEYPRESS_COMPLETE_IND event.
 */
typedef bt_address_t bt_gap_send_keypress_complete_ind_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_USER_PASSKEY_REQUEST_IND event.
 */
typedef bt_address_t bt_gap_user_passkey_request_ind_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_DELETE_LINK_KEY_IND event.
 */
typedef bt_address_t bt_gap_delete_link_key_ind_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_DISCOVERY_CNF event.
 */
typedef uint8_t bt_gap_discovery_cnf_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_CANCEL_INQUIRY_CNF event.
 */
typedef uint8_t bt_gap_cancel_inquiry_cnf_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_WRITE_INQUIRY_TX_CNF event.
 */
typedef uint8_t bt_gap_write_inquiry_tx_cnf_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_SET_SCAN_MODE_CNF event.
 */
typedef uint8_t bt_gap_set_scan_mode_cnf_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_POWER_ON_CNF event.
 */
typedef uint8_t bt_gap_power_on_cnf_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_POWER_OFF_CNF event.
 */
typedef uint8_t bt_gap_power_off_cnf_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_SET_SNIFF_SUBRATE_POLICY_CNF event.
 */
typedef uint8_t bt_gap_set_sniff_subrate_policy_cnf_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_ENTER_TEST_MODE_CNF event.
 */
typedef uint8_t bt_gap_enter_test_mode_cnf_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_PIN_CODE_RESPONSE_CNF event.
 */
typedef uint8_t bt_gap_pin_code_response_cnf_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_IO_CAPABILITY_RESPONSE_CNF event.
 */
typedef uint8_t bt_gap_io_capability_response_cnf_t;
/**
 *  @deprecated This type defines a parameter of the #BT_GAP_USER_CONFIRM_RESPONSE_CNF event.
 */
...
/** @defgroup BA_Bluetoothbt_gap_struct Struct
  * @{
  */

/**
 *  @deprecated Sniff information.
 */
typedef struct {
...
/**
 *  @deprecated Page scan information.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_BONDING_CNF event.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_AUTHENTICATE_RESULT_IND event.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_USER_PASSKEY_NOTIFICATION_IND event.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_KEYPRESS_NOTIFICATION_IND event.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_BONDING_RESULT_IND event.
 */
typedef struct {
    bt_status_t result;                       /**< The status indicates if the bonding completed successfully or not. */
    bt_address_t dev_addr;                    /**< Bluetooth address of the remote device. */
...
/**
 *  @deprecated Connection information.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_DISCOVERY_RESULT_IND event.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_READ_RSSI_CNF event.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_READ_REMOTE_NAME_CNF event.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_READ_INQUIRY_RESPONSE_TX_CNF event.
 */
typedef struct {
...
/**
 *  @deprecated Connection link result.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_SET_ROLE_CNF event.
 */
typedef struct {
...
/**
 *  @deprecated This event structure provides parameters of the #BT_GAP_DETACH_SINGLE_LINK_CNF event.
 */
...
/**
 * @deprecated                 This function switches roles of master and slave devices.
...
/**
 * @deprecated                 This function gets the role of a remote device.
 * @param[in] remote_addr is the Bluetooth address of a remote device.
...
/**
 * @deprecated                  This function causes the BR/EDR controller to enter the inquiry mode. It is used to discover other nearby BR/EDR devices.
...
/**
 * @deprecated                  This function causes the BR/EDR controller to stop the current inquiry.
...
/**
 * @deprecated                 This function obtains the user-friendly name of a remote device.
 * @param[in] remote_addr is the Bluetooth address of a remote device.
...
/**
 * @deprecated              This function writes the inquiry transmit power level used to transmit the inquiry data packets during the inquiry.
...
/**
 * @deprecated              This function reads the power level used to transmit the FHS and EIR data packets during the inquiry response.
 * @return             If the operation is pending, the returned value is #BT_STATUS_GAP_PENDING, otherwise the returned value is #BT_STATUS_GAP_FAILED.
 */
bt_status_t bt_gap_read_inquiry_response_tx(void);

/**
 * @deprecated          This function sets the scan mode. Call this API after the #BT_GAP_POWER_ON_CNF event is received.
...
/**
 * @deprecated                 This function reads the RSSI value of a remote device.
 * @param[in] remote_addr is the Bluetooth address of a remote device.
 * @return                If the operation is pending, the returned value is #BT_STATUS_GAP_PENDING, otherwise the returned value is #BT_STATUS_GAP_FAILED.
 */
...
/**
 * @deprecated          This function enables the local BR/EDR controller to enter test mode.
 * @return         If the operation is pending, the returned value is #BT_STATUS_GAP_PENDING, otherwise the returned value is #BT_STATUS_GAP_FAILED.
 */
bt_status_t bt_gap_enter_test_mode(void);

/**
 * @deprecated                        This function specifies the parameters for sniff sub-rating for a given link.
 * @param[in] remote_addr        is the Bluetooth address of a remote device.
...
/**
 * @deprecated                 This function replies to a PIN code request event from the BR/EDR controller, and specifies the PIN code to use for a connection.
...
/**
 * @deprecated                 This function terminates an existing connection.
...
/**
 * @deprecated                      This function replies to an I/O capability request event from the controller, and specifies the current I/O capability of the host.
...
/**
 * @deprecated                 This function replies to a user confirmation request event.
 * @param[in] remote_addr is the Bluetooth address of a remote device.
...
/**
 * @deprecated                   This function replies to a user passkey request event.
 * @param[in] remote_addr   is the Bluetooth address of a remote device.
...
/**
 * @deprecated          This function powers on the Bluetooth and initializes the profiles.
...
/**
 * @deprecated          This function powers off the Bluetooth and de-initializes the profiles. The user should terminate the existing connection before powers off the Bluetooth.
 * @return         If the operation completes successfully, the returned value is #BT_STATUS_SUCCESS;
 *                 if the operation is pending, the returned value is #BT_STATUS_GAP_PENDING.
 */
...
/**
 * @deprecated                 This function reads the connection ID.
...
/**
 * @deprecated             This function reads the connection information.
...
/**
 * @deprecated          This function is a user-defined API to provide the name. The GAP will read the name and modify the user-friendly name for the BR/EDR controller.
...
/**
 * @deprecated          This function is a user-defined API to provide the COD. The GAP will read the COD and modify the COD value in the BR/EDR controller.
 * @return         The returned value is the COD of the device.
 */
uint32_t bt_gap_get_local_cod(void);

/**
 * @deprecated                This function is a user-defined API to provide the address. The GAP will read the address and modify the Bluetooth controller address.
...
/**
 * @deprecated                 This function connects two Bluetooth devices based on a common link key.
 * @param[in] remote_addr is the Bluetooth address of a remote device.
 * @return                If the operation is pending, the returned value is #BT_STATUS_GAP_PENDING, otherwise the returned value is #BT_STATUS_GAP_FAILED.
 */
...
/**
 * @deprecated              This function is a static callback for a user to listen to the event. It is a user-defined API.
...
/**
 * @deprecated                 This function is a user-defined API to provide the link key. The GAP will read the link key and use it in the pairing process.
 * @param[in] remote_addr is the Bluetooth address of a remote device.
...
/**
 * @deprecated                This function reads the local Bluetooth address of the device.
...
/**
 * @deprecated                This function sets the sniff requirements in the sniff mode.

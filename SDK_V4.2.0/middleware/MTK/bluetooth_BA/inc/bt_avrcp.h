 ...
 * @{
 * @addtogroup BA_BluetoothBTAVRCP AVRCP
 * @{
...
/**
 * @defgroup BA_Bluetoothbt_avrcp_define Define
 * @{
 */

/**
 * @deprecated The maxinum number of player application setting attributes.
 */
#define BT_AVRCP_MAX_APP_ATTRIBUTE_NUM              (4)
/**
 * @deprecated The maxinum number of player application setting attibute values.
 */
#define BT_AVRCP_MAX_APP_ATTRIBUTE_VALUE_NUM        (4)
/**
 * @deprecated The maxinum length of a string text.
 */
#define BT_AVRCP_MAX_APP_ATTRIBUTE_STRING_SIZE      (80)
/**
 * @deprecated The maxinum number of media elements quiried at once.
 */
#define BT_AVRCP_MAX_ELEMENT_ATTRIBUTE_NUM          (10)
/**
 * @deprecated The maxinum number of element attributes.
 */
...
/**
 * @defgroup BA_Bluetoothbt_avrcp_enum Enum
 * @{
 */

/**
 * @deprecated Version type.
 */
typedef enum {
...
/**
 * @deprecated Support feature type.
 */
typedef enum {
...
/**
 * @deprecated Command control type.
 */
typedef enum {
...
/**
 * @deprecated Player application setting attributes type.
 */
typedef enum {
...
/**
 * @deprecated Media attribute type.
 */
typedef enum {
...
/**
 * @deprecated Notification event type.
 */
typedef enum {
...
/**
 * @defgroup BA_Bluetoothbt_avrcp_struct Struct
 * @{
 */
/**
 * @deprecated Structure for the AVRCP initialization parameters.
 */
typedef struct {
...
/**
 * @deprecated The connect confirmation structure for event #BT_AVRCP_CONNECT_CNF.
 */
typedef struct {
...
/**
 * @deprecated The connect indication structure for event #BT_AVRCP_CONNECT_IND.
 */
typedef struct {
    bt_address_t device_addr;                                      /**< Bluetooth address of remote device. */
...
/**
 * @deprecated The disconnect indication structure for event #BT_AVRCP_DISCONNECT_IND.
 */
typedef struct {
    uint16_t conn_id;                                               /**< Current connection ID. */
...
/**
 * @deprecated The pass through confirmation structure for event #BT_AVRCP_PASS_THROUGHT_CNF.
 */
typedef struct {
    bt_status_t result;                                            /**< General result of the confirm. */
    uint16_t conn_id;                                              /**< Current connection ID. */
...
/**
 * @deprecated The list application attributes confirmation structure for event #BT_AVRCP_LIST_APP_ATTRIBUTES_CNF.
 */
typedef struct {
    bt_status_t result;                                            /**< General result of the confirm. */
    uint16_t conn_id;                                              /**< Current connection ID. */
...
/**
 * @deprecated The list application value confirmation structure for event #BT_AVRCP_LIST_APP_VALUE_CNF.
 */
typedef struct {
    bt_status_t result;                                            /**< General result of the confirm. */
...
/**
 * @deprecated The get application value confirmation structure for event #BT_AVRCP_GET_APP_VALUE_CNF.
 */
typedef struct {
    bt_status_t result;                                            /**< General result of the confirm. */
    uint16_t conn_id;                                              /**< Current connection ID. */
...
/**
 * @deprecated The set application value confirmation structure for event #BT_AVRCP_SET_APP_VALUE_CNF.
 */
typedef struct {
    bt_status_t result;                                            /**< General result of the confirm. */
    uint16_t conn_id;                                              /**< Current connection ID. */
...
/**
 * @deprecated The get attribute text confirmation structure for event #BT_AVRCP_GET_ATTRIBUTE_TEXT_CNF.
 */
typedef struct {
    bt_status_t result;                                            /**< General result of the confirm. */
...
/**
 * @deprecated The get value text confirmation structure for event #BT_AVRCP_GET_VALUE_TEXT_CNF.
 */
typedef struct {
    bt_status_t result;                                            /**< General result of the confirm. */
    uint8_t count;                                                 /**< The number of player application settings value provided. */
...
/**
 * @deprecated Structure for element atrributes.
 */
typedef struct {
...
/**
 * @deprecated The get elment attributes confirmation structure for event #BT_AVRCP_GET_ELEMENT_ATTRIBUTES_CNF.
 */
typedef struct {
    bt_status_t result;                                                             /**< General result of the confirm. */
    uint8_t count;                                                                  /**< The number of attributes provided. */
...
/**
 * @deprecated The get player status confirmation structure for event #BT_AVRCP_GET_PLAYER_STATUS_CNF.
 */
typedef struct {
    bt_status_t result;                                            /**< General result of the confirm. */
    uint16_t conn_id;                                              /**< Current connection ID. */
...
/**
 * @deprecated The register notification confirmation structure for event #BT_AVRCP_REGISTER_NOTIFICATION_CNF.
 */
typedef struct {
    bt_status_t result;                                            /**< General result of the confirm. */
    uint16_t conn_id;                                              /**< Current connection ID. */
...
/**
 * @deprecated                 This function connects to the specified remote
...
/**
 * @deprecated                 This function responds to the specified remote device's
...
/**
 * @deprecated             This function disconnects the specified remote device.
...
/**
 * @deprecated               This function sends pass through command to
...
/**
 * @deprecated             This function gets player application attributes
...
/**
 * @deprecated             This function gets the player application values
...
/**
 * @deprecated             This function queries the player application setting values
...
/**
 * @deprecated             This function sets the player application setting values
...
/**
 * @deprecated             This function requests the TG device to provide
...
/**
 * @deprecated             This function obtains the detailed information on a
...
/**
 * @deprecated             This function gets the status of the currently
...
/**
 * @deprecated                    This function sends a register notification command to the
...
/**
 * @deprecated              This function is the common callback with indication or
...
/**
 * @deprecated            This function is to gets the initialization parameters. It is user defined.

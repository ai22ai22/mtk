 ...
 * @{
 * @addtogroup BA_BluetoothBTA2DP A2DP
 * @{
...
/**
 * @defgroup BA_Bluetoothbt_a2dp_enum Enum
 * @{
 */

/**
 *  @deprecated This enum defines the A2DP codec type.
 */
typedef enum {
...
/**
 *  @deprecated This enum defines the A2DP role type.
 */
typedef enum {
...
/**
 *  @deprecated This enum defines A2DP state type.
 */
typedef enum {
...
/**
 * @defgroup BA_Bluetoothbt_a2dp_struct Struct
 * @{
 */

/**
 *  @deprecated This struct defines the SBC codec details.
 */
typedef struct {
...
/**
 *  @deprecated This struct defines the AAC codec details.
 */
typedef struct {
...
/**
 *  @deprecated This union defines the A2DP codec.
 */
typedef union {
...
/**
 *  @deprecated This struct defines the A2DP codec capability.
 */
typedef struct {
...
/**
 *  @deprecated This struct defines the result of BT_A2DP_CONNECT_IND event.
 */
typedef struct {
...
/**
 *  @deprecated This struct defines BT_A2DP_CONNECT_CNF result.
 */
typedef struct {
...
/**
 *  @deprecated This struct defines BT_A2DP_DISCONNECT_IND result.
 */
typedef struct {
    uint16_t conn_id;           /**< Connection ID. */
...
/**
 *  @deprecated This struct defines BT_A2DP_DISCONNECT_CNF result.
 */
typedef struct {
...
/**
 *  @deprecated This struct defines BT_A2DP_START_STREAMING_IND result.
 */
typedef struct {
    uint16_t conn_id;                           /**< Connection ID. */
...
/**
 *  @deprecated This struct defines BT_A2DP_START_STREAMING_CNF result.
 */
typedef struct {
...
/**
 *  @deprecated This struct defines BT_A2DP_SUSPEND_STREAMING_IND result.
 */
typedef struct {
    uint16_t conn_id;                           /**< Connection ID. */
...
/**
 *  @deprecated This struct defines BT_A2DP_SUSPEND_STREAMING_CNF result.
 */
typedef struct {
...
/**
 *  @deprecated This struct defines BT_A2DP_RECONFIGURE_IND result.
 */
typedef struct {
    uint16_t conn_id;                           /**< Connection ID. */
    bt_a2dp_codec_capability_t codec_cap;       /**< Streaming channel codec capability. */
...
/**
 *  @deprecated This struct defines BT_A2DP_RECONFIGURE_CNF result.
 */
typedef struct {
...
/**
 *  @deprecated This struct defines BT_A2DP_STREAM_RECEIVED_IND result.
 */
typedef struct {
    uint16_t conn_id;                           /**< Connection ID. */
...
/**
 *  @deprecated This struct defines initialization parameters.
 */
typedef struct {
...
/**
 * @deprecated               This function is employed to connect the specified remote device. #BT_A2DP_CONNECT_CNF event will be sent to the upper layer with connection request result.
...
/**
 * @deprecated               This function is employed to respond the specified remote device incoming connection. #BT_A2DP_CONNECT_CNF event will be sent to the upper layer with connection request result.
...
/**
 * @deprecated               This function is employed to disconnect the specified remote device. #BT_A2DP_DISCONNECT_CNF event will be sent to the upper layer with disconnection request result.
 * @param[in] conn_id   is the identifier of the remote device.
 * @return              If the operation was successful, the returned value is #BT_STATUS_A2DP_OK, otherwise the returned value is less than zero.
...
/**
 * @deprecated               This function is employed to respond to the incoming streaming from the specified remote device.
 * @param[in] conn_id   is the identifier of the remote device.
...
/**
 * @deprecated               This function is employed to respond to suspended streaming from the specified remote device .
 * @param[in] conn_id   is the identifier of the remote device.
...
/**
 * @deprecated               This function is employed to respond to the reconfiguration of the specified remote device.
 * @param[in] conn_id   is the identifier of the remote device.
...
/**
 * @deprecated               This function is employed to get local role for the specified remote device.
 * @param[in] conn_id   is the identifier of the remote device.
...
/**
 * @deprecated               This function is employed to get local state for the specified remote device.
 * @param[in] conn_id   is the identifier of the remote device.
...
/**
 * @deprecated               This function is employed to get codec capability for the specified remote device.
 * @param[in] conn_id   is the identifier of the remote device.
...
/**
 * @deprecated               This function is the common callback with indication or response result to the upper layer.
...
/**
 * @deprecated               This function is A2DP initialization API. Implementation is required.

 ...
 * @{
 * @addtogroup BA_BluetoothCommonBLE_2 Bluetooth Low Energy events
 * @{
...
/**
 * @defgroup BA_Bluetoothble_events_define Define
 * @{
 */
...
/**
 * @defgroup BA_Bluetoothble_events_enum Enum
 * @{
 */

/** @deprecated This enumeration defines the Bluetooth Low Energy events. */
typedef enum {

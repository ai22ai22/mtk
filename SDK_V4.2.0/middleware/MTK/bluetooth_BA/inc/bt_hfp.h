 ...
 * @{
 * @addtogroup BA_BluetoothBTHFP HFP
 * @{
...
/**
 * @defgroup BA_Bluetoothbt_hf_define Define
 * @{
 */

/**
 * @deprecated The maximum size of the phone number for the HF call operation.
 */
...
/**
 * @defgroup BA_Bluetoothbt_hf_enum Enum
 * @{
 */


/**
 * @deprecated HF supported CODEC.
 */
...
/**
 * @deprecated HF supported profiles.
 */
...
/**
 * @deprecated This enum defines the HF feature set.
 */
typedef enum {
...
/**
 * @deprecated This enum defines the AG feature set.
 */
typedef enum {
...
/**
 * @deprecated This enum defines the gateway's 3-Way calling (hold) feature set.
 */
typedef enum {
...
/**
 * @deprecated This enum defines the current call state indicated by the AG.
 */
typedef enum {
...
/**
 * @deprecated This enum defines the current call setup state indicated by the AG.
 */
typedef enum {
...
/**
 * @deprecated This enum defines the current call held state indicated by the AG.
 */
typedef enum {
...
/**
 * @deprecated This enum defines the current state of a call.  Not all states are supported by all
...
/**
 * @deprecated This enum defines the call mode.
 */
typedef enum {
...
/**
 * @deprecated This enum defines the indicator status.
 */
typedef enum {
...
/**
 * @deprecated This enum defines the CHLD actions.
 */
typedef enum {
...
/**
 * @deprecated This enum defines the switch audio direction actions.
 */
typedef enum {
...
/**
 * @defgroup BA_Bluetoothbt_hf_struct Struct
 * @{
 */

/**
 *  @deprecated This is the common structure the HF indication events which haven't the special data.
 */
typedef struct {
...
/**
 *  @deprecated This structure defines #BT_HF_RING_IND result.
 */
typedef bt_hf_common_ind_t bt_hf_ring_ind_t;


/**
 *  @deprecated This structure defines #BT_HF_CONNECT_REQUEST_IND result.
 */
typedef struct {
...
/**
 *  @deprecated This structure defines #BT_HF_SLC_CONNECT_IND result.
 */
typedef struct {
    uint16_t                conn_id;                    /**<  Current connection ID.*/
    bt_address_t            dev_addr;                   /**<  The Bluetooth address of a remote device.*/
...
/**
 *  @deprecated This structure defines #BT_HF_SLC_DISCONNECT_IND result.
 */
typedef struct {
    uint16_t              conn_id;                      /**<  Current connection ID.*/
    bt_address_t          dev_addr;                     /**<  The Bluetooth address of a remote device.*/
...
/**
 *  @deprecated This structure defines #BT_HF_AUDIO_CONNECT_IND result.
 */
typedef struct {
    uint16_t                     conn_id;               /**<  Current connection ID.*/
...
/**
 *  @deprecated This structure defines #BT_HF_AUDIO_DISCONNECT_IND result.
 */
typedef struct {
    uint16_t              conn_id;                      /**<  Current connection ID.*/
...
/**
 *  @deprecated This structure defines #BT_HF_BRSF_FEATURES_IND result.
 */
typedef struct {
    uint16_t                    conn_id;               /**<  Current connection ID.*/
...
/**
 *  @deprecated This structure defines #BT_HF_CALL_HELD_FEATURES_IND result.
 */
typedef struct {
    uint16_t                       conn_id;             /**<  Current connection ID.*/
...
/**
 *  @deprecated This structure defines #BT_HF_CIEV_CALL_IND result.
 */
typedef struct {
    uint16_t                       conn_id;             /**<  Current connection ID.*/
...
/**
 *  @deprecated This structure defines #BT_HF_CIEV_CALL_SETUP_IND result.
 */
typedef struct {
    uint16_t                       conn_id;             /**<  Current connection ID.*/
...
/**
 *  @deprecated This structure defines #BT_HF_CIEV_CALL_HELD_IND result.
 */
typedef struct {
    uint16_t                      conn_id;              /**<  Current connection ID.*/
...
/**
 *  @deprecated This structure defines #BT_HF_CALL_WAITING_IND result.
 */
typedef struct {
    uint16_t              conn_id;                                /**<  Current connection ID.*/
...
/**
 *  @deprecated This structure defines #BT_HF_CALLER_ID_IND result.
 */
typedef struct {
    uint16_t              conn_id;                                  /**<  Current connection ID.*/
...
/**
 *  @deprecated This structure defines #BT_HF_CURRENT_CALLS_IND result.
 */
typedef struct {
    uint16_t              conn_id;                                   /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_CIEV_SERVICE_IND result.
 */
typedef struct {
    uint16_t              conn_id;                          /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_CIEV_BATTCHG_IND result.
 */
typedef struct {
    uint16_t              conn_id;                          /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_CIEV_SIGNAL_IND result.
 */
typedef struct {
    uint16_t              conn_id;                          /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_CIEV_ROAM_IND result.
 */
typedef struct {
    uint16_t               conn_id;                         /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_VOICE_RECOGNITION_IND result.
 */
typedef struct {
    uint16_t              conn_id;                          /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_IN_BAND_RING_IND result.
 */
typedef struct {
    uint16_t              conn_id;                          /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_VOLUME_SYNC_SPEAKER_GAIN_IND result.
 */
typedef struct {
    uint16_t              conn_id;                          /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_VOLUME_SYNC_MIC_GAIN_IND result.
 */
typedef struct {
    uint16_t              conn_id;                          /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_EXTRA_INDICATOR_INFO_IND result.
 */
typedef struct {
    uint16_t              conn_id;                          /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_EXTRA_INDICATOR_UPDATE_IND result.
 */
typedef struct {
    uint16_t              conn_id;                          /**<  Current connection ID. */
    uint16_t              indicator_index;                  /**<  The index of an indicator in the AG. */
...
/**
 *  @deprecated The general structure of the AG confirmation.
 */
typedef struct {
    uint16_t              conn_id;                          /**<  Current connection ID. */
...
/**
 *  @deprecated This structure defines #BT_HF_SLC_CONNECT_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_connect_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_DIAL_NUMBER_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_dial_number_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_ENABLE_VOICE_RECOGNITION_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_enable_voice_recognition_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_ENABLE_CALLER_ID_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_enable_caller_id_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_ANSWER_CALL_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_answer_call_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_TERMINATE_CALL_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_terminate_call_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_ENABLE_CALL_WAITING_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_enable_call_waiting_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_CALL_HOLD_ACTION_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_call_hold_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_DTMF_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_dtmf_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_CURRENT_CALLS_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_current_calls_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_MEMORY_DIAL_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_memory_dial_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_SPEAKER_VOLUME_SYNC_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_speaker_volume_sync_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_MIC_VOLUME_SYNC_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_mic_volume_sync_cnf_t;


/**
 *  @deprecated This structure defines #BT_HS_SEND_KEYPAD_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hs_send_keypad_cnf_t;


/**
 *  @deprecated This structure defines #BT_HF_EXTERN_AT_CMD_CNF result.
 */
typedef bt_hf_general_cnf_t bt_hf_extern_at_cmd_cnf_t;


/**
 *  @deprecated This structure defines the status ofoptional indicators.
 */
typedef struct {
...
/**
 *  @deprecated This structure defines the initialize params of the HF.
 */
typedef struct {
...
/**
 * @deprecated                                            This function sends a HFP connect request to the AG. The event #BT_HF_SLC_CONNECT_CNF restuns the connection result.
...
/**
 * @deprecated                                            This function sends a keypad command(AT+CKPD = 200) request to the AG.
...
/**
 * @deprecated                                            This function sends a HFP disconnect request to AG. the event #BT_HF_SLC_DISCONNECT_IND returnes current reuqest's reslut.
 * @param[in] conn_id                                Current connection ID.
 * @return                                           Check the result of the request sending.
 *                                                   If it is successful, the returned value is zero;
 *                                                   if it failed, the returned value is less than zero.
...
/**
 * @deprecated                                            This function sends an enable call waiting command(AT+CCWA) request to the AG.
...
/**
 * @deprecated                                            This function sends an enable call line identification notification command(AT+CLIP) request to the AG.
...
/**
 * @deprecated                                            This function sends an enable voice recognition activation command(AT+BRVA) request to the AG.
...
/**
 * @deprecated                                            This function sends an answer the call or reject the call command(ATA or AT+CHUP) request to the AG.
...
/**
 * @deprecated                                            This function sends a reject the call command( AT+CHUP) request to the AG.
...
/**
 * @deprecated                                            This function sends a dial by number command(ATDddd...dd) request to the AG.
...
/**
 * @deprecated                                            This function sends a dial by AG memory command(ATD>Nan...) request to the AG.
...
/**
 * @deprecated                                            This function sends a dial by the last number command(AT+BLDN) request to the AG.
...
/**
 * @deprecated                                            This function sends a call hold action command(AT+CHLD) request to the AG.
...
/**
 * @deprecated                                            This function sends a speaker volume sync command(AT+VGS) request to the AG.
...
/**
 * @deprecated                                            This function sends a microphone volume sync command(AT+VMS) request to the AG.
...
/**
 * @deprecated                                            This function sends a DTMF sending command(AT+VTS) request to the AG.
...
/**
 * @deprecated                                            This function sends a query current calls command(AT+CLCC) request to the AG.
...
/**
 * @deprecated                                            Transfer the audio direction with the AG.
 * @param[in] conn_id                                The id of current connection.
...
/**
 * @deprecated                                            Disconnect the SCO link.
 * @param[in] conn_id                                The id of current connection.
 * @return                                           Check the result of the request sending.
 *                                                   If it is successful, the returned value is zero;
 *                                                   if it failed, the returned value is less than zero.
...
/**
 * @deprecated                                            This function sends a AT command which defined by app to AG.
...
/**
 * @deprecated                                            The connection response when the AG wants to connect to platform.
...
/**
 * @deprecated                                            This function is the common callback with indication or response result to the application.
...
/**
 * @deprecated                                            The function initializes the HF.

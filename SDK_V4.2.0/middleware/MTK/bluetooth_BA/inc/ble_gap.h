 ...
 * @{
 * @addtogroup BA_BluetoothBLEGAP GAP
 * @{
...
/** @defgroup BA_Bluetoothble_gap_enum Enum
  * @{
  */

/**
 *  @deprecated Bluetooth Low Energy scan type, invoked in #ble_gap_set_scan_params() API.
 */
typedef enum {
...
/**
 *  @deprecated Bluetooth Low Energy advertising type.
 */
typedef enum {
...
/**
 *  @deprecated Bluetooth Low Energy role type of device for every connection.
 */
typedef enum {
...
/**
 *  @deprecated The filter type of scanning.
 */
typedef enum {
...
/**
 *  @deprecated The filter type of a connection.
 */
typedef enum {
...
/** @defgroup BA_Bluetoothble_gap_struct Struct
  * @{
  */

/**
 *    @deprecated The connection characteristics.
 */
typedef struct {
...
/**
 *    @deprecated The time related characteristics of a connection.
 */
typedef struct {
...
/**
 *    @deprecated The scanning parameters.
 */
typedef struct {
...
/**
 *    @deprecated This event structure presents the GAP connectivity parameters. #BLE_GAP_CONNECTED_IND event.
...
/**
 *    @deprecated This event structure presents the GAP disconnected event. #BLE_GAP_DISCONNECTED_IND event.
 *    @sa ble_gap_get_connection_info()
 */
typedef struct {
    ble_status_t      error_code;             /**< The event status. */
...
/**
 *    @deprecated This event structure presents the GAP connection parameter update. #BLE_GAP_CONNECTION_PARAM_UPDATED_IND event.
 */
typedef struct {
    uint16_t conn_id;               /**< Range(0..0xF00], 0 is invalid ID. */
    uint16_t conn_interval;         /**< Range[6..0xC80], Time = N * 1.25 msec. */
...
/**
 *    @deprecated This event structure presents parameters to receive the RSSI. #BLE_GAP_REPORT_RSSI_IND event.
 *    @sa ble_gap_get_rssi()
 */
typedef struct {
    ble_status_t error_code;       /**< The event status. */
...
/**
 *    @deprecated This event structure presents advertising parameters. #BLE_GAP_ADVERTISING_IND event.
 */
typedef struct {
...
/**
 *  @deprecated This event structure presents Bluetooth power on parameters. #BLE_POWER_ON_CNF event.
 */
typedef struct {
...
/**
 *  @deprecated This event structure presents Bluetooth power off parameters. #BLE_POWER_OFF_CNF event.
 */
typedef struct {
    uint8_t result;                /**< If successful, return #BLE_STATUS_SUCCESS, otherwise return an error. */
} ble_power_off_cnf_t;
...
/**
 * @deprecated              This function is a user defined API for a static callback to listen to the Bluetooth Low Energy GAP events.
...
/**
 * @deprecated                      This function is a user defined API for giving public address to the controller.
...
/**
 * @deprecated              This function sets the random address for the device, It's suggested to invoke after the Bluetooth is powered on.
...
/**
 * @deprecated              This function obtains the random address of the device. It's suggested to invoke after the Bluetooth is powered on and random address is set.
...
/**
 * @deprecated                       This function sets the advertising buffer. It provides data to scanning packets that have a data field.
...
/**
 * @deprecated                   This function adds a single device to the white list stored in the controller.
...
/**
 * @deprecated                   This function cleans up the white listed devices added by #ble_gap_add_white_list().
 * @return                  #BLE_STATUS_SUCCESS, if the operation completed successfully, otherwise an error occurred.
...
/**
 * @deprecated                          This function sets the advertising parameters.
...
/**
 * @deprecated            This function starts the advertiser.
 * @return           #BLE_STATUS_SUCCESS, if the operation completed successfully, otherwise an error occurred.
...
/**
 * @deprecated       This function stops the advertiser.
 * @return      #BLE_STATUS_SUCCESS, if the operation completed successfully, otherwise an error occurred.
...
/**
 * @deprecated                  This function updates the connection parameters. A #BLE_GAP_CONNECTION_PARAM_UPDATED_IND event is reported when finished.
...
/**
 * @deprecated                   This function sets the scan parameters.
...
/**
 * @deprecated     This function stops the scanner.
 * @return    #BLE_STATUS_SUCCESS, if the operation completed successfully, otherwise an error occurred.
 */
ble_status_t ble_gap_stop_scanner(void);

/**
 * @deprecated                         This function creates a Link Layer connection to a connectable advertiser.
...
/**
 * @deprecated          This function cancels the connection procedure initiated by #ble_gap_connect().
 * @return         #BLE_STATUS_SUCCESS, if the operation completed successfully, otherwise an error occurred.
 * @sa             ble_gap_connect()
 */
...
/**
 * @deprecated                 This function disconnects a Link Layer connection.
...
/**
 * @deprecated                      This function reads the Received Signal Strength Indication (RSSI) value from the controller.
 * @param[in] conn_id          is the connection ID.
 * @return                     #BLE_STATUS_SUCCESS, if the operation completed successfully, otherwise an error occurred.
 * @par       Example
 * @code
...
/**
 * @deprecated                 This function obtains the connection ID using the address of a remote device.
...
/**
 * @deprecated                  This function obtains the connection information using the connection ID.
 * @param[in] conn_id      is the connection ID.
...
/**
 * @deprecated                      This function sets the local device name.
...
/**
 * @deprecated                      This function obtains the local device name.
...
/**
 * @deprecated                      This function sets the local device appearance.
...
/**
 * @deprecated                      This function obtains the local device appearance.
...
/**
 * @deprecated                      This function sets the local device peripheral preferred connection parameters.
...
/**
 * @deprecated                      This function obtains the local device peripheral preferred connection parameters.
...
/**
 * @deprecated                    This function obtains the public address for the device, It's suggested to invoke after the Bluetooth is powered on.
...
/**
 * @deprecated          This function powers on the Bluetooth and initializes profiles.
...
/**
 * @deprecated          This function powers off the Bluetooth and de-initializes profiles.

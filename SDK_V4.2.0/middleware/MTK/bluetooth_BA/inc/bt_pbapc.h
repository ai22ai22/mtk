 ...
 * @{
 * @addtogroup BA_BluetoothBTPBAPC PBAPC
 * @{
...
/**
 * @defgroup BA_Bluetoothbt_pbapc_define Define
 * @{
 */
...
/**
 * @defgroup BA_Bluetoothbt_pbapc_enum Enum
 * @{
 */

/**
 * @deprecated This enum defines folder types.
 */
typedef enum {
...
/**
 *  @deprecated This enum defines vCard format types.
 */
typedef enum {
...
/**
 * @deprecated This enum defines sort order types.
 */
typedef enum {
...
/**
*  @deprecated This enum defines search attribute types.
*/
typedef enum {
...
/**
 * @defgroup BA_Bluetoothbt_pbapc_struct Struct
 * @{
 */

/**
 *  @deprecated This structure defines details of the pull phonebook request.
 */
typedef struct {
...
/**
 *  @deprecated This structure defines details of the pull vCard-listing request.
 */
typedef struct {
...
/**
 *  @deprecated This structure defines details of the pull vCard object request.
 */
typedef struct {
    uint32_t filter;            /**< vCard filter */
    bt_pbapc_vcard_format_t format; /**< vCard format */
...
/**
 * @deprecated This structure defines the #BT_PBAPC_CONNECT_CNF event result.
 */
typedef struct {
...
/**
 * @deprecated This structure defines the #BT_PBAPC_DISCONNECT_IND event result.
 */
typedef struct {
    uint16_t conn_id;           /**< Connection ID. */
...
/**
 * @deprecated This structure defines the #BT_PBAPC_SET_PHONEBOOK_CNF event result.
 */
typedef struct {
    uint16_t conn_id;           /**< Connection ID. */
...
/**
 * @deprecated This structure defines the #BT_PBAPC_PULL_PHONEBOOK_CNF event result.
 */
typedef struct {
    uint16_t conn_id;           /**< Connection ID. */
...
/**
 * @deprecated This structure defines the #BT_PBAPC_PULL_VCARD_ENTRY_CNF event result.
 */
typedef struct {
    uint16_t conn_id;           /**< Connection ID. */
...
/**
 *  @deprecated This structure defines the #BT_PBAPC_PULL_VCARD_LISTING_CNF event result.
 */
typedef struct {
...
/**
 *  @deprecated This structure defines the #BT_PBAPC_ABORT_CNF event result.
 */
typedef struct {
    uint16_t conn_id;           /**< Connection ID. */
...
/**
 *  @deprecated This structure defines the #BT_PBAPC_DATA_IND event result.
 */
typedef struct {
    uint16_t conn_id;           /**< Connection ID. */
...
/**
 *  @deprecated This structure defines the #BT_PBAPC_AUTH_RESPONSE_CNF event result.
 */
typedef struct {
...
/**
 *  @deprecated This structure defines the #BT_PBAPC_AUTH_IND event result.
 */
typedef struct {
    bt_address_t addr;          /**< Remote device's address. */
...
/**
 * @deprecated               This function connects to the specified remote device.
...
/**
 * @deprecated               This function processes authentication in this connection.
...
/**
 * @deprecated               This function is disconnects from the specified remote device.
...
/**
 * @deprecated               This function downloads the phonebook objects from the specified remote device.
...
/**
 * @deprecated               This function changes the path used with browsing phonebook objects from specified remote device.
...
/**
 * @deprecated               This function pulls the vCard-listing of the current phonebook from the specified remote device.
...
/**
 * @deprecated               This function pulls a specific vCard object from the specified remote device.
...
/**
 * @deprecated               This function stops the current pull operations.
...
/**
 * @deprecated               This function gets the current PBAPC links number.

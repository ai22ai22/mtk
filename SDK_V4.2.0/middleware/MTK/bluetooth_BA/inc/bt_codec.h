 ...
 * @{
 * @addtogroup BA_BluetoothBTCommon_4 Bluetooth codec
 * @{
...
/** @defgroup BA_Bluetoothbt_codec_enum Enum
  * @{
  */

/** @deprecated Bluetooth codec state */
typedef enum {
...
/** @defgroup BA_Bluetoothbt_codec_struct Struct
  * @{
  */
...
/** @deprecated A2DP audio handle structure type*/
typedef struct bt_media_handle_s bt_media_handle_t;

/** @deprecated A2DP audio handle structure */
...
/** @deprecated The A2DP audio codec structure */
typedef struct {
...
/** @deprecated The HFP codec structure */
typedef struct {
...
/** @defgroup BA_Bluetoothbt_codec_typedef Typedef
  * @{
  */

/** @deprecated  This defines the A2DP codec callback function prototype.
...
/** @deprecated  This defines the HFP codec callback function prototype.
...
/**
 * @deprecated     This function opens the A2DP audio codec.
...
/**
 * @deprecated     This function closes the A2DP audio codec.
...
/**
 * @deprecated     This function opens the HFP audio codec.
...
/**
 * @deprecated     This function closes the HFP codec.

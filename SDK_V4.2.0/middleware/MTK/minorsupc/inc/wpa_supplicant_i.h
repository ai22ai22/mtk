...
static __inline int rsn_preauth_init(struct wpa_supplicant *wpa_s, u8 *dst)
{
    return -1;
}

static __inline void rsn_preauth_deinit(struct wpa_supplicant *wpa_s)
{
}
static __inline void rsn_preauth_scan_results(struct wpa_supplicant *wpa_s,
        wndrv_supc_bss_info_struct *results,
        int count)
{
}

static __inline void pmksa_candidate_add(struct wpa_supplicant *wpa_s,
        const u8 *bssid,
        int prio)
{
}

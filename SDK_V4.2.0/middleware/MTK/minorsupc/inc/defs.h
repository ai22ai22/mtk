...
static __inline int wpa_key_mgmt_wpa_ieee8021x(int akm)
{
...
static __inline int wpa_key_mgmt_wpa_psk(int akm)
{
...
static __inline int wpa_key_mgmt_ft(int akm)
{
    return akm == WPA_KEY_MGMT_FT_PSK ||
           akm == WPA_KEY_MGMT_FT_IEEE8021X;
}

static __inline int wpa_key_mgmt_sha256(int akm)
{

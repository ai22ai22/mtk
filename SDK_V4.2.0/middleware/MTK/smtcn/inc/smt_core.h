...
typedef void (*aes128_decrypt_cb)(unsigned char *cipher_blk, unsigned short cipher_blk_size,
                                  unsigned char *key, unsigned char key_len,
                                  unsigned char *plain_blk, unsigned short *plain_blk_size);
...
int elian_init(char *la, const struct efunc_table *tbl, const unsigned char *key);

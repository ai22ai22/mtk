...
Usage:          GCC: Please add "include $(SOURCE_DIR)/middleware/MTK/nvdm/module.mk" in your GCC project Makefile.
                KEIL: Please drag the middleware/MTK/nvdm/lib/libnvdm_xxx_KEIL.lib and middleware/MTK/nvdm/src folder to your project. Please define the macro PRODUCT_VERSION and MTK_NVDM_ENABLE in KEIL, and add middleware/MTK/nvdm/inc to include paths.
                IAR: Please drag the middleware/MTK/nvdm/lib/libnvdm_xxx_IAR.a and middleware/MTK/nvdm/src folder to your project. Please define the macro PRODUCT_VERSION and MTK_NVDM_ENABLE in IAR, and add middleware/MTK/nvdm/inc to include paths.

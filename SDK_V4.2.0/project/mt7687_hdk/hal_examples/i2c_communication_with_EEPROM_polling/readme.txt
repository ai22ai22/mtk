 ...
 * @{
 * @addtogroup mt7687_hdk_hal_examples_i2c_communication_with_EEPROM_polling i2c_communication_with_EEPROM_polling
 * @{
...
@par Run the example
  - Build the example project with a command "./build.sh mt7687_hdk
    ...
    download the binary file to the LinkIt 7687 HDK.

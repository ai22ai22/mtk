 ...
 * @{
 * @addtogroup mt7687_hdk_hal_examples_i2c_communication_with_EEPROM_dma i2c_communication_with_EEPROM_dma
 * @{
...
@par Directory contents
  ...
  - Project configuration files using Keil IDE
    - \b MDK-ARM/i2c_communication_with_EEPROM_dma.uvprojx:
                             uVision5 project file. Contains the project
                             structure in XML format.
    - \b MDK-ARM/i2c_communication_with_EEPROM_dma.uvoptx:

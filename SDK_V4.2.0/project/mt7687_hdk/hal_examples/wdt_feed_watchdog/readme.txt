...
@par Overview
  - Example description
    - This example is a reference application to use WDT APIs to feed the
      watchdog.
    - This example does not require FreeRTOS.
  - Results
    - The system will reboots after a prompted delay..
...
@par Run the example
  ...
  - Run the example. The log on the Tera terminal, such as "WDT will reset in
    4 seconds" will show the time when the system reboots.
*/
/**
 * @}
 * @}

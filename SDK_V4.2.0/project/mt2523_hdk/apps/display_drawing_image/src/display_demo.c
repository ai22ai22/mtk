...
void display_demo_task(void *param)
{
    ...
    BSP_LCD_GetParam(LCM_IOCTRL_QUERY__LCM_SETTING_PARAM, &lcm_setting);
    ...
    layer_para.row_size = width;
    layer_para.column_size = height;
	...
	while(1)
    {
        ...
        BSP_LCD_UpdateScreen(roi_para.target_start_x, roi_para.target_start_y, roi_para.target_end_x, roi_para.target_end_y);

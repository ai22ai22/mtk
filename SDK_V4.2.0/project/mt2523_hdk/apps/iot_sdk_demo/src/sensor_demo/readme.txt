...
@par Hardware and software environment
  - Supported HDK
    - LinkIt 2523 HDK.
    - MediaTek MT2511 biosensor daughterboard (model number: MTK0067). For
      more information, please refer to
      [sdk_root]/doc/HDK/MT2511_Biosensor_Daughterboard_users_guide.
    - Optical module sub-board (model number: WS3524). For more information,
      please refer to
      [sdk_root]/doc/HDK/MT2511_Biosensor_Daughterboard_users_guide.
  ...
  - Environment configuration
    ...
    - For hardware configuration schematic diagram, please refer to
      [sdk_root]/doc/HDK/MT2511_Biosensor_Daughterboard_users_guide. Pleae
      refer to figure 2 in above-mentioned user guide for MT2511 biosensor
      daughterboard jumper setting. Pleae refer to figure 4 in above-
      mentioned user guide for LinkIt 2523 HDK jumper setting.

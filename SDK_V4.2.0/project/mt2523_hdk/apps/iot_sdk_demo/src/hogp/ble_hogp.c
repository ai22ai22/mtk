...
#define HOGP_CHAR_PNP_ID_VALUE_HANDLE               (0x0712)
#define HOGP_CHAR_BATTERY_LEVEL_VALUE_HANDLE        (0x0717)
#define HOGP_CHAR_REPORT_MAP_VALUE_HANDLE           (0x0727)
#define HOGP_CHAR_REPORT_VALUE_HANDLE               (0x0729)
#define HOGP_CHAR_HID_INFO_VALUE_HANDLE             (0x072D)
#define HOGP_CHAR_HID_CONTROL_POINT_VALUE_HANDLE    (0x072F)
#define HOGP_CHAR_HID_PROTOCOL_MODE_VALUE_HANDLE    (0x0731)
#define HOGP_CHAR_HID_BK_INPUT_VALUE_HANDLE         (0x0733)
#define HOGP_CHAR_HID_BK_OUTPUT_VALUE_HANDLE        (0x0736)
...
const bt_gatts_service_t bt_if_hogp_device_info_service = {
    .starting_handle = 0x0710,
    .ending_handle = 0x0712,
...
const bt_gatts_service_t bt_if_hogp_battery_service = {
    .starting_handle = 0x0715,
    .ending_handle = 0x0718,
    .required_encryption_key_size = 0,
...
BT_GATTS_NEW_CHARC_VALUE_CALLBACK(bt_if_char_report_map_value, HOGP_CHAR_REPORT_MAP_UUID128,
    BT_GATTS_REC_PERM_READABLE, ble_hogp_char_report_map_value_cb);
...
const bt_gatts_service_t bt_if_hogp_hid_service = {
    .starting_handle = 0x0725,
    .ending_handle = 0x0736,
    .required_encryption_key_size = 0,
...
static void ble_hogp_send_indication(uint8_t key)
{
    ...
    //if (g_hogp_p->report_ccc == 0x0001) { /*indication enabled*/
        bt_gattc_charc_value_notification_indication_t *req = 
                        (bt_gattc_charc_value_notification_indication_t *)pvPortMalloc(8 + 4);;

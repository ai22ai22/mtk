 ...
 * @{
 * @addtogroup mt2523_hdk_hal_examples_eint_edge_falling_configuration eint_edge_falling_configuration
 * @{
...
@par Run the example
  - Build the example project with a command "./build.sh mt2523_hdk
    eint_edge_falling_configuration bl" from the SDK root folder and download

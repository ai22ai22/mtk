...
#else
        int weekAngle[7] = { 360 / 7, 360 * 2 / 7, 360 * 3 / 7, 360 * 4 / 7, 360 * 5 / 7, 360 * 6 / 7, 0 };
        weekHand.updateAngle(weekAngle[rtc_time.rtc_week - 1]);
#endif
...
void HomeView::addPlayerScreen()
{
    ...
    Unicode::strncpy(songValueBuffer, "Sleeping To Dream\nLive From Montal...", 40);

...
#endif
#define PPG_SAMPLE_RUN_SEC          (8)
#define PPG_SAMPLE_RUN_LED_PHASE    (6)
#define PPG_SAMPLE_RUN_AMB_PHASE    (8)
#ifndef PPG_128HZ
#define LED_CUR_TEST_LEN    (4000) // 125(sample rate)*4(sec)*8(led)    (led and ambient)
#define AMBDAC_CUR_TEST_LEN (24000) // 125(sample rate)*4(sec)*8(led) * 6(ambient)
#else
            ...
            /* This is original smt test case*/
                ...
                if(s1) {
                    ...
                    if (test_item == 1) {                        
                        ...
                        char *s2 = NULL, *s3 = NULL, *s4 = NULL;
                        uint32_t sub_setting = 0, tia_gain = 0, tia_cf = 0, led_cur_range = 0;
                        s2 = strtok(NULL, ",");
                        if(s2) {

...
#else
#define LOGI(fmt, arg...)       printf("[FOTA_UBIN] "fmt,##arg)
#define LOGW(fmt, arg...)       printf("[FOTA_UBIN] "fmt,##arg)
#define LOGE(fmt, arg...)       printf("[FOTA_UBIN] "fmt,##arg)

#define PRINT_FUNC_ADDR(x)      printf("[FOTA_UBIN] call address = %x\r\n", (uint32_t*)x)
#endif
...
typedef enum
{
    ...
    //ohrm_set_mode_fota_wrapper_idx,    // not defined in sensor fusion library
    HRV_initialization_fota_wrapper_idx,                        /* 12 */
    HRV_process_data_fota_wrapper_idx,
    HRV_estimate_fota_wrapper_idx,
    hr_fet_init_fota_wrapper_idx,                               /* 15 */
    ...
    ppg_control_get_version_fota_wrapper_idx,                   /* 31 */
    ...
    bp_alg_init_fota_wrapper_idx,                               /* 36 */

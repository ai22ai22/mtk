  ...
  - There are 8 cases for Bluetooth low power operation, as shown below:
    - Case 1.
      - Description: Bluetooth LE 3T3R 1.28s Advertising (9 bytes Data"Mediatek")
        ...
        - Step 7. Wait for least 5 seconds, or until "POWER ON" is displayed.
    ...
    - Case 4.
      - Description: Bluetooth Classic Sniff 0.5s, 4 attempts
        ...
        - Step 10.Smartphone (made from Mediatek) connects to a device.
    ...
    - Case 8.
      - Description:
        ...
        - [Device_A as SLAVE speaker2, not smartphone].
          ...
          - Step 10. Waiting for speaker1 to connect.
        - [Device_B is the same as device as MASTER speaker1, not smartphone].
          ...
          - Step 19. AT+BTSINK=PREV,PRESSUP\0d\0a for inquiry and connect to
            speaker2.
          - Step 20. Smartphone inquiries and connects to speaker1 in 90s when speaker1 connects
          to speaker2 successfully.
        - [Switch to Device_A]

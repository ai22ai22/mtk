...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\dma.s
//
///////////////////////////////////////////////////////////////////////////////
...
NVIC_EnableIRQ:
        ...
        AND      R2,R0,#0x1F
        LSLS     R1,R1,R2
        LDR.W    R2,??DataTable31  ;; 0xe000e100
        LSRS     R0,R0,#+5
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_DisableIRQ:
        ...
        AND      R2,R0,#0x1F
        LSLS     R1,R1,R2
        LDR.W    R2,??DataTable31_1  ;; 0xe000e180
        LSRS     R0,R0,#+5
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
//   76     DMA_ACKI(channel);
        MOV      R1,#+32768
        LDR.W    R2,??DataTable31_5  ;; 0x83010020
        ADDS     R0,R2,R0, LSL #+8
        STR      R1,[R0, #+0]
//   77 }
        BX       LR               ;; return
...
//  140     if (index > DMA_MAX_FULL_CHANNEL) {
        MOV      R4,R1
        CMP      R4,#+3
        BLT.N    ??DMA_FullSize_CheckIdleChannel_0
//  141         return handle;
        MOV      R0,R2
        B.N      ??DMA_FullSize_CheckIdleChannel_1
//  142     }
//  143 
...
??DMA_FullSize_CheckIdleChannel_0:
        ...
        LSRS     R6,R6,R1
        LSLS     R6,R6,#+31
        BPL.N    ??DMA_FullSize_CheckIdleChannel_2
//  145 
//  146         handle = index;
        MOV      R2,R1
//  147 
...
??DMA_FullSize_CheckIdleChannel_2:
        MSR      PRIMASK,R3
//  154 
//  155 
...
//  186     if (DMA_CheckRunStat(dma_no)) {
        MOV      R7,R8
        LDR.W    R0,??DataTable31_7  ;; 0x83010000
        MOVS     R1,#+1
        CMP      R7,#+17
        BLT.N    ??DMA_Config_Internal_1
        LDR      R2,[R0, #+4]
        BLT.N    ??DMA_Config_Internal_2
        SUB      R3,R8,#+17
        LSLS     R3,R3,#+1
        LSLS     R1,R1,R3
...
??DMA_Config_Internal_7:
        MOVS     R1,#+2
        CMP      R7,#+17
        BLT.N    ??DMA_Config_Internal_9
        LDR      R0,[R0, #+4]
        BLT.N    ??DMA_Config_Internal_10
        SUB      R2,R8,#+17
        LSLS     R2,R2,#+1
        LSLS     R1,R1,R2
...
??DMA_Config_Internal_25:
        ...
        LDR      R2,[R4, #+8]
        LDR      R2,[R2, #+8]
        LDR.W    R3,??DataTable31_11  ;; 0x83010004
        ADDS     R1,R3,R7, LSL #+8
        STR      R2,[R1, #+0]
...
??DMA_Config_Internal_37:
        ...
        LDR      R0,[R4, #+8]
        LDR      R0,[R0, #+4]
        LDR.W    R2,??DataTable31_11  ;; 0x83010004
        ADDS     R1,R2,R7, LSL #+8
        STR      R0,[R1, #+0]
        MOVS     R0,#+12
        B.N      ??DMA_Config_Internal_26
??DMA_Config_Internal_38:
        ...
        ORR      R0,R0,#0x14
        CMP      R5,#+0
        BNE.N    ??DMA_Config_Internal_39
        LDR      R2,[R2, #+8]
        LDR.W    R3,??DataTable31_12  ;; 0x83010008
        ADDS     R3,R3,R7, LSL #+8
        STR      R2,[R3, #+0]
        LDR      R2,[R4, #+8]
        LDR      R2,[R2, #+12]
        LDR.W    R3,??DataTable31_13  ;; 0x8301000c
        ADDS     R3,R3,R7, LSL #+8
        STR      R2,[R3, #+0]
        LDR      R2,[R4, #+8]
        LDR      R2,[R2, #+4]
        LDR.W    R3,??DataTable31_8  ;; 0x8301002c
        ADDS     R1,R3,R7, LSL #+8
        STR      R2,[R1, #+0]
        CMP      R6,#+0
        BEQ.W    ??DMA_Config_Internal_26
        ORR      R0,R0,#0x20
        B.N      ??DMA_Config_Internal_26
...
??DMA_LISR_2:
        ...
        BGE.N    ??DMA_LISR_8
        ADDS     R5,R4,#+1
        LDR.W    R0,??DataTable31_15  ;; 0x8301011c
        ADDS     R0,R0,R4, LSL #+8
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+16
        BPL.N    ??DMA_LISR_7
        ...
        BL       DMA_Stop
        MOV      R0,#+32768
        LDR.W    R1,??DataTable31_16  ;; 0x83010120
        ADDS     R1,R1,R4, LSL #+8
        STR      R0,[R1, #+0]
??DMA_LISR_6:
        ADDS     R2,R4,#+1
...
??DMA_LISR_12:
        ...
        ADDS     R0,R0,R4, LSL #+8
        LDR      R0,[R0, #+0]
        LDR.W    R1,??DataTable31_17  ;; 0x8301001c
        ADDS     R1,R1,R4, LSL #+8
        LDR      R1,[R1, #+0]
        LSLS     R1,R1,#+16
        BPL.N    ??DMA_LISR_15
        ...
        DATA
??DMA_LISR_0:
        DC8      0xA,0x11,0x18,0x1F
        DC8      0x26,0x2D,0x34,0x3B
        DC8      0x8,0x42,0x49,0x50
        DC8      0x57,0x5F,0x9,0x0
        THUMB
??DMA_LISR_17:
        B.N      ??DMA_LISR_14
??DMA_LISR_18:
...
??DMA_LISR_34:
        MOV      R0,#+65536
        LDR.N    R1,??DataTable31_5  ;; 0x83010020
        ADDS     R1,R1,R4, LSL #+8
        STR      R0,[R1, #+0]
??DMA_LISR_35:
        ADDS     R4,R4,#+1
??DMA_LISR_32:
        CMP      R4,#+26
        BGE.N    ??DMA_LISR_36
        LDR.N    R0,??DataTable31_9  ;; 0x83010014
        ADDS     R0,R0,R4, LSL #+8
        LDR      R0,[R0, #+0]
        LDR.W    R1,??DataTable31_17  ;; 0x8301001c
        ADDS     R1,R1,R4, LSL #+8
        ...
        DATA
??DMA_LISR_1:
        DC8      0xA,0x10,0x16,0x1C
        DC8      0x22,0x28,0x2E,0x34
        DC8      0x8,0x3A,0x40,0x46
        DC8      0x4C,0x52,0x9,0x0
        THUMB
??DMA_LISR_37:
        B.N      ??DMA_LISR_34
??DMA_LISR_38:
...
//  804     DRV_WriteReg32(DMA_CON(VDMA_I2S_TX_CH), dma_con);
        LDR.N    R0,??DataTable31_20  ;; 0x600612
        LDR.N    R1,??DataTable31_21  ;; 0x83010c14
        STR      R0,[R1, #+0]
//  805 
...
//  808     DRV_WriteReg32(DMA_CON(VDMA_I2S_RX_CH), dma_con);
        LDR.N    R0,??DataTable31_22  ;; 0x740612
        LDR.N    R1,??DataTable31_23  ;; 0x83010d14
        STR      R0,[R1, #+0]
//  809 
...
//  812     DRV_WriteReg32(DMA_CON(VDMA_UART1TX_CH), dma_con);
        LDR.N    R0,??DataTable31_24  ;; 0x800010
        LDR.N    R1,??DataTable31_25  ;; 0x83010e14
        STR      R0,[R1, #+0]
//  813 
...
//  816     DRV_WriteReg32(DMA_CON(VDMA_UART1RX_CH), dma_con);
        LDR.N    R0,??DataTable31_26  ;; 0x94c010
        LDR.N    R1,??DataTable31_27  ;; 0x83010f14
        STR      R0,[R1, #+0]
//  817 
...
//  820     DRV_WriteReg32(DMA_CON(VDMA_UART2TX_CH), dma_con);
        LDR.N    R0,??DataTable31_28  ;; 0xa00010
        LDR.N    R1,??DataTable31_29  ;; 0x83011014
        STR      R0,[R1, #+0]
//  821 
...
//  824     DRV_WriteReg32(DMA_CON(VDMA_UART2RX_CH), dma_con);
        LDR.N    R0,??DataTable31_30  ;; 0xb4c010
        LDR.N    R1,??DataTable31_31  ;; 0x83011114
        STR      R0,[R1, #+0]
//  825 
...
//  828     DRV_WriteReg32(DMA_CON(VDMA_BTIF_TX_CH), dma_con);
        LDR.N    R0,??DataTable31_32  ;; 0xc00010
        LDR.N    R1,??DataTable31_33  ;; 0x83011214
        STR      R0,[R1, #+0]
//  829 
...
//  832     DRV_WriteReg32(DMA_CON(VDMA_BTIF_RX_CH), dma_con);
        LDR.N    R0,??DataTable31_34  ;; 0xd4c010
        LDR.N    R1,??DataTable31_35  ;; 0x83011314
        STR      R0,[R1, #+0]
//  833 
...
//  836     DRV_WriteReg32(DMA_CON(VDMA_USB_EP2O_CH), dma_con);
        LDR.N    R0,??DataTable31_36  ;; 0xf48010
        LDR.N    R1,??DataTable31_37  ;; 0x83011414
        STR      R0,[R1, #+0]
//  837 
...
//  840     DRV_WriteReg32(DMA_CON(VDMA_USB_EP3I_CH), dma_con);
        LDR.N    R0,??DataTable31_38  ;; 0x1048010
        LDR.N    R1,??DataTable31_39  ;; 0x83011514
        STR      R0,[R1, #+0]
//  841 
...
//  844     DRV_WriteReg32(DMA_CON(VDMA_USB_EP3O_CH), dma_con);
        LDR.N    R0,??DataTable31_40  ;; 0x1148010
        LDR.N    R1,??DataTable31_41  ;; 0x83011614
        STR      R0,[R1, #+0]
//  845 
...
//  848     DRV_WriteReg32(DMA_CON(VDMA_USB_EP4I_CH), dma_con);
        LDR.N    R0,??DataTable31_42  ;; 0x1248010
        LDR.N    R1,??DataTable31_43  ;; 0x83011714
        STR      R0,[R1, #+0]
//  849 
...
//  852     DRV_WriteReg32(DMA_CON(VDMA_USB_EP4O_CH), dma_con);
        LDR.N    R0,??DataTable31_44  ;; 0x1348010
        LDR.N    R1,??DataTable31_45  ;; 0x83011814
        STR      R0,[R1, #+0]
//  853 
...
//  856     DRV_WriteReg32(DMA_CON(VDMA_ADC_RX_CH), dma_con);
        LDR.N    R0,??DataTable31_46  ;; 0x144c012
        LDR.N    R1,??DataTable31_47  ;; 0x83011914
        STR      R0,[R1, #+0]
//  857 
//  858 }
        POP      {R0,PC}          ;; return
...
//  867     DRV_WriteReg32(DMA_PGMADDR(ch), adrs);
        LDR.N    R4,??DataTable31_8  ;; 0x8301002c
        ADDS     R4,R4,R2, LSL #+8
        STR      R0,[R4, #+0]
//  868     DRV_WriteReg32(DMA_FFSIZE(ch), len);
        LDR.N    R0,??DataTable31_48  ;; 0x83010044
        ADDS     R0,R0,R2, LSL #+8
        STR      R1,[R0, #+0]
//  869     DRV_WriteReg32(DMA_ALTLEN(ch), alt_len);
        LDR.N    R0,??DataTable31_49  ;; 0x83010040
        ADDS     R0,R0,R2, LSL #+8
        STR      R3,[R0, #+0]
//  870     DRV_Reg32(DMA_COUNT(ch)) = dma_count;
        LDR      R0,[SP, #+4]
        LDR.N    R1,??DataTable31_10  ;; 0x83010010
        ADDS     R1,R1,R2, LSL #+8
        STR      R0,[R1, #+0]
//  871     DRV_Reg32(DMA_TO(ch)) = timeout_counter;
        LDR      R0,[SP, #+8]
        LDR.N    R1,??DataTable31_50  ;; 0x83010050
        ADDS     R1,R1,R2, LSL #+8
        STR      R0,[R1, #+0]
//  872 }
        POP      {R4}
...
DMA_Vfifo_Set_timeout:
        LDR.N    R2,??DataTable31_50  ;; 0x83010050
        ADD      R0,R2,R0, LSL #+8
        STR      R1,[R0, #+0]
//  878 }
        BX       LR               ;; return
...
DMA_Clock_Enable:
        ...
        SUBS     R0,R0,#+1
        LSL      R0,R1,R0
        LDR.N    R1,??DataTable31_51  ;; 0x83000018
        STR      R0,[R1, #+0]
//  915 }
        BX       LR               ;; return
...
DMA_Clock_Disable:
        ...
        SUBS     R0,R0,#+1
        LSL      R0,R1,R0
        LDR.N    R1,??DataTable31_52  ;; 0x83000014
        STR      R0,[R1, #+0]
//  920 }
        BX       LR               ;; return

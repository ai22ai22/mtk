...
//    Endian       =  little
//    Source file  =  
//        C:\LEO\myGit\MTK IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\top.c
//    Command line =  
//        "C:\LEO\myGit\MTK IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\top.c"
...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\top.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC cmnSerialFlashClkConfTo64M
...
//   55     unsigned long reg = HAL_REG_32(TOP_AON_CM4_STRAP_STA);
        LDR.W    R0,??DataTable9  ;; 0x830081b8
        LDR      R1,[R0, #+8]
...
??top_xtal_init_2:
        LDR.W    R1,??DataTable9_1  ;; 0x1312d00
...
??top_xtal_init_3:
        LDR.W    R1,??DataTable9_3  ;; 0x18cba80
        LDR.W    R3,??DataTable9_2
        STR      R1,[R3, #+0]
...
??top_xtal_init_4:
        LDR.W    R1,??DataTable9_4  ;; 0x3197500
...
??top_xtal_init_5:
        LDR.N    R1,??DataTable9_5  ;; 0x2625a00
        LDR.N    R3,??DataTable9_2
        STR      R1,[R3, #+0]
...
//  123     reg = cmnReadRegister32(pTopCfgCM4PWRCtl);
        LDR.N    R4,??DataTable9  ;; 0x830081b8
        MOV      R0,R4
...
//  150     reg = cmnReadRegister32(pTopCfgCM4PWRCtl);
        LDR.N    R5,??DataTable9  ;; 0x830081b8
        MOV      R0,R5
          CFI FunCall cmnReadRegister32
        BL       cmnReadRegister32
        STR      R0,[SP, #+0]
...
//  221     reg = cmnReadRegister32(pTopCfgCM4CKG);
        LDR.N    R4,??DataTable9_7  ;; 0x830081b0
        MOV      R0,R4
          CFI FunCall cmnReadRegister32
        BL       cmnReadRegister32
        STR      R0,[SP, #+0]
...
//  272     gCpuFrequency = MCU_FREQUENCY_192MHZ;
        LDR.N    R0,??DataTable9_8  ;; 0xb71b000
        LDR.N    R1,??DataTable9_2
        STR      R0,[R1, #+4]
...
//  310     gCpuFrequency = MCU_FREQUENCY_160MHZ;
        LDR.N    R0,??DataTable9_9  ;; 0x9896800
        LDR.N    R1,??DataTable9_2
        STR      R0,[R1, #+4]
...
//  343     gCpuFrequency = MCU_FREQUENCY_64MHZ;
        LDR.N    R0,??DataTable9_10  ;; 0x3d09000
        LDR.N    R1,??DataTable9_2
        STR      R0,[R1, #+4]
...
//  357     reg = cmnReadRegister32(pTopCfgHclk);
        LDR.N    R4,??DataTable21  ;; 0x830081b4
        MOV      R0,R4
          CFI FunCall cmnReadRegister32
        BL       cmnReadRegister32
        STR      R0,[SP, #+0]
...
//  366 //
        ...
        SECTION `.ramTEXT`:CODE:NOROOT(1)
          ...
          CFI Function cmnSerialFlashClkConfTo64M
        THUMB
...
//  382     mSetHWEntry(SFC_MISC1_DEL_LATCH_LATENCY, 0);
        LDR.N    R0,??DataTable21_1  ;; 0x83070008
        LDR      R1,[R0, #+0]
        LSRS     R1,R1,#+2
        LSLS     R1,R1,#+2
        STR      R1,[R0, #+0]

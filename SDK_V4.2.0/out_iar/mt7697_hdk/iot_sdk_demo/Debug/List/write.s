...
//        7.5\arm\src\lib\write.c
//    Command line =  
//        "C:\Program Files (x86)\IAR Systems\Embedded Workbench
//        7.5\arm\src\lib\write.c" -D MTK_LOAD_MAC_ADDR_FROM_EFUSE -D
//        MTK_PING_OUT_ENABLE -D MTK_WIFI_PROFILE_ENABLE -D PCFG_OS=2 -D
//        _REENT_SMALL -D MTK_MINISUPP_ENABLE -D MTK_MINICLI_ENABLE -D
//        MTK_BSPEXT_ENABLE -D MTK_HAL_LOWPOWER_ENABLE -D MTK_LWIP_ENABLE -D
...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\write.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Program Files (x86)\IAR Systems\Embedded Workbench 7.5\arm\src\lib\write.c
//    1 /*******************
//    2  *
...
//   25 _STD_BEGIN
//   26 
//   27 #pragma module_name = "?__write"
//   28 
//   29 int MyLowLevelPutchar(int x);
//   30 
//   31 /*
...
//   36 
        ...
        SECTION `.text`:CODE:NOROOT(1)
          ...
          CFI NoCalls
        THUMB
//   37 size_t __write(int handle, const unsigned char * buffer, size_t size)
//   38 {
//   39   /* Remove the #if #endif pair to enable the implementation */
//   40 #if 0    
//   41 
//   42   size_t nChars = 0;
//   43 
...
//   45   {
//   46     /*
//   47      * This means that we should flush internal buffers.  Since we
//   48      * don't we just return.  (Remember, "handle" == -1 means that all
//   49      * handles should be flushed.)
//   50      */
//   51     return 0;
//   52   }
//   53 
//   54   /* This template only writes to "standard out" and "standard err",
//   55    * for all other file handles it returns failure. */
//   56   if (handle != _LLIO_STDOUT && handle != _LLIO_STDERR)
//   57   {
//   58     return _LLIO_ERROR;
//   59   }
//   60 
//   61   for (/* Empty */; size != 0; --size)
//   62   {
//   63     if (MyLowLevelPutchar(*buffer++) < 0)
//   64     {
...
//   73 #else
//   74 
//   75   /* Always return error code when implementation is disabled. */

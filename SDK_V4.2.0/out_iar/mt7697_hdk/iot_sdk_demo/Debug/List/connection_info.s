...
//    Source file  =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\project\mt7697_hdk\apps\iot_sdk_demo\src\ut_app\connection_info.c
//    Command line =  
//        "C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\project\mt7697_hdk\apps\iot_sdk_demo\src\ut_app\connection_info.c"
...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\connection_info.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\LEO\myGit\MTK IOT\SDK_V4.2.0\project\mt7697_hdk\apps\iot_sdk_demo\src\ut_app\connection_info.c
...
??dump_connection_info_list_0:
        CMP      R4,#+16
        BGE.N    ??dump_connection_info_list_4
        MOVS     R0,#+11
        SMULBB   R7,R0,R4
        LDRH     R0,[R6, R7]
        CMP      R0,#+0
        BEQ.N    ??dump_connection_info_list_3
        ADDS     R0,R6,R7
        LDRB     R1,[R0, #+2]
        CMP      R1,#+0
        BEQ.N    ??dump_connection_info_list_1
        ADR.W    R5,?_2
        B.N      ??dump_connection_info_list_2
//   70         }
//   71     }
//   72 }
...
//  150 }
        ...
        THUMB
//  151 void clear_bonded_info(void)
//  152 {
clear_bonded_info:
        PUSH     {R3-R7,LR}
          CFI R14 Frame(CFA, -4)

...
//    Endian       =  little
//    Source file  =  
//        C:\LEO\myGit\MTK IOT\SDK_V4.2.0\kernel\service\src\syslog_cli.c
//    Command line =  
//        "C:\LEO\myGit\MTK IOT\SDK_V4.2.0\kernel\service\src\syslog_cli.c" -D
...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\syslog_cli.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   54         printf("<log_switch>   := on | off\n");
        ADR.W    R0,?_3
          CFI FunCall printf
        BL       printf
//   55         printf("<print_level>  := info | warning | error\n");
        ADR.W    R0,?_4
          CFI FunCall printf
        BL       printf
//   56         return 1;
...
??syslog_cli_show_config_0:
        LDR      R0,[SP, #+4]
        CMP      R0,#+0
        BEQ.N    ??syslog_cli_show_config_2
        LDR      R0,[R0, R4, LSL #+2]
        CMP      R0,#+0
        BNE.N    ??syslog_cli_show_config_1
//   97 
//   98     return 0;
??syslog_cli_show_config_2:
        MOVS     R0,#+0
...
?_3:
        ...
        DATA
?_4:
        DC8 "<print_level>  := info | warning | error\012"
        DC8 0, 0

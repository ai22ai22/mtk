...
//    Endian       =  little
//    Source file  =  
//        C:\LEO\myGit\MTK IOT\SDK_V4.2.0\driver\chip\mt7687\src\hal_pwm.c
//    Command line =  
//        "C:\LEO\myGit\MTK IOT\SDK_V4.2.0\driver\chip\mt7687\src\hal_pwm.c" -D
...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\hal_pwm.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   72     uint32_t source_clock_rate = source_clock_table[source_clock];
        ADR.W    R3,`hal_pwm_calc_total_count::source_clock_table`
        LDR      R0,[R3, R0, LSL #+2]

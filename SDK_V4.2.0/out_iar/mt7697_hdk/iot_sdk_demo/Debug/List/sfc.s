...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\sfc.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  373     SFC_WriteReg32(RW_SFC_MAC_CTL, val);
        LDR.N    R2,??DataTable12_7  ;; 0xefffffeb
        ANDS     R1,R2,R1
        STR      R1,[R0, #+0]
//  374 
...
??sfc_transfer_0:
        LDR.N    R7,??DataTable12_8  ;; 0x83070800
        MOV      R1,R7
//  429 
...
//  437             SFC_WriteReg32(CM4_SFC_BASE + 0x8008, (1 << 6)); //0x00000040;
        LDR.N    R3,??DataTable12_9  ;; 0x83078008
        MOV      R12,#+64
        STR      R12,[R3, #+0]
...
??sfc_transfer_8:
        LDR.N    R0,??DataTable12_10  ;; 0x83070010
        STR      R4,[R0, #+0]

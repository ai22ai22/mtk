...
//    Source file  =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\driver\chip\mt7687\src\hal_i2c_master.c
//    Command line =  
//        "C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\driver\chip\mt7687\src\hal_i2c_master.c" -D
...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\hal_i2c_master.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\LEO\myGit\MTK IOT\SDK_V4.2.0\driver\chip\mt7687\src\hal_i2c_master.c
...
NVIC_EnableIRQ:
        ...
        AND      R2,R0,#0x1F
        LSLS     R1,R1,R2
        LDR.W    R2,??DataTable39  ;; 0xe000e100
        LSRS     R0,R0,#+5
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_DisableIRQ:
        ...
        AND      R2,R0,#0x1F
        LSLS     R1,R1,R2
        LDR.W    R2,??DataTable39_1  ;; 0xe000e180
        LSRS     R0,R0,#+5
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
??hal_i2c_callback_2:
        LDRB     R1,[R5, #+1]
        CMP      R1,#+0
        BEQ.N    ??hal_i2c_callback_3
//  164         if (ucAckLen > 8) {
        CMP      R6,#+9
        BCC.N    ??hal_i2c_callback_4
//  165             ucAckCheckLen = 8;
        MOV      R10,#+8
//  166         }
...
// 2 790 bytes in section .text
// 
// 2 790 bytes of CODE  memory

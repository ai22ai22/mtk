...
//    Source file  =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\low_hal_irrx.c
//    Command line =  
//        "C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\low_hal_irrx.c" -D
...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\low_hal_irrx.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\LEO\myGit\MTK IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\low_hal_irrx.c
...
NVIC_EnableIRQ:
        ...
        AND      R2,R0,#0x1F
        LSLS     R1,R1,R2
        LDR.N    R2,??DataTable13  ;; 0xe000e100
        LSRS     R0,R0,#+5
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
halIrRxClearInterrupt:
        LDR.N    R0,??DataTable13_3  ;; 0x83068020
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x1
        STR      R1,[R0, #+0]
//  100 }
...
//  173     UINT32  u4RegAddr = (UINT32)(&(pIRRXTypeDef->CHK_DATA0));
        LDR.N    R3,??DataTable13_8  ;; 0x83068030
...
//  362         u4ChkPeriod = (u4OKPeriod * u4SAPeriod * IRRX_BUS_FREQ) / (0xFF * IRRX_OPER_FREQ);
        ...
        UDIV     R0,R0,R1
        MUL      R0,R0,R10
        LDR.N    R1,??DataTable13_10  ;; 0x7c830
        UDIV     R10,R0,R1
...
??halIrRxPulseWidthDetect_2:
        LDR.N    R0,??DataTable13_5  ;; 0x8306800c
        LDR      R1,[R0, #+0]
//  391 
...
??halIrRxPulseWidthDetect_5:
        LDR.N    R2,??DataTable13_11  ;; 0xff00bf3f
        ANDS     R1,R2,R1
        ORR      R1,R1,R7, LSL #+16
        ORR      R1,R1,#0x2000
        STR      R1,[R0, #+0]
...
??halIrRxPulseWidthDetect_DVT_5:
        LDR.N    R2,??DataTable13_12  ;; 0xff00bfff
        ANDS     R0,R2,R0
        ORR      R0,R0,R5, LSL #+16
        ORR      R0,R0,#0x2000
        STR      R0,[R1, #+0]

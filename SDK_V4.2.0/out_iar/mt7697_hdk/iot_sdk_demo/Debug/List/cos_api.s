...
//    Source file  =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\cos_api.c
//    Command line =  
//        "C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\cos_api.c" -D
...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\cos_api.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\LEO\myGit\MTK IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\cos_api.c
...
//   87     next_seed = (next_seed * 1103515245) + 12345; /* permutate seed */
        MOVW     R0,#+12345
        LDR.N    R1,??DataTable2  ;; 0x41c64e6d
...
//   98     return (result & 0xffffffff);
        LDR.N    R1,??DataTable2_2  ;; 0x3ff80
        AND      R1,R1,R3, LSR #+14
        ADDS     R1,R1,R4, LSL #+18
        ADD      R0,R1,R0, LSR #+25
        POP      {R4}
          CFI R4 SameValue
          CFI CFA R13+0
...
//  105         mSetHWEntry(TOP_CFG_AON_N9_CM4_MESSAGE_CM4_ADC, 1);
        LDR.N    R0,??DataTable2_3  ;; 0x81021054
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x2
        STR      R1,[R0, #+0]
...
//  122     mSetHWEntry(TOP_CFG_AON_PMU_RG_BUCK_FORCE_PWM, 0x101);
        LDR.N    R0,??DataTable2_4  ;; 0x8102140c
        LDR      R1,[R0, #+0]
        ORR      R1,R1,#0x400000
        ORR      R1,R1,#0x4000
        STR      R1,[R0, #+0]
...
//  137         mSetHWEntry(TOP_CFG_AON_N9_CM4_MESSAGE_CM4_ADC, 0);
        LDR.N    R0,??DataTable2_5  ;; 0x81021050
        LDR      R1,[R0, #+4]
        BIC      R1,R1,#0x2
        STR      R1,[R0, #+4]
...
//  156     mSetHWEntry(TOP_CFG_AON_PMU_RG_BUCK_FORCE_PWM, 0x000);
        LDR.N    R0,??DataTable2_4  ;; 0x8102140c
        LDR      R1,[R0, #+0]
        LDR.N    R2,??DataTable2_6  ;; 0xffbfbfff
        ANDS     R1,R2,R1
        STR      R1,[R0, #+0]
//  157 

...
//    Source file  =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\hal_gpio_7687.c
//    Command line =  
//        "C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\hal_gpio_7687.c" -D
...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\hal_gpio_7687.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\LEO\myGit\MTK IOT\SDK_V4.2.0\driver\chip\mt7687\src\common\hal_gpio_7687.c
...
NVIC_EnableIRQ:
        ...
        AND      R2,R0,#0x1F
        LSLS     R1,R1,R2
        LDR.W    R2,??DataTable26  ;; 0xe000e100
        LSRS     R0,R0,#+5
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_DisableIRQ:
        ...
        AND      R2,R0,#0x1F
        LSLS     R1,R1,R2
        LDR.W    R2,??DataTable26_1  ;; 0xe000e180
        LSRS     R0,R0,#+5
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
NVIC_ClearPendingIRQ:
        ...
        AND      R2,R0,#0x1F
        LSLS     R1,R1,R2
        LDR.W    R2,??DataTable26_2  ;; 0xe000e280
        LSRS     R0,R0,#+5
        STR      R1,[R2, R0, LSL #+2]
        BX       LR               ;; return
...
??halGPO_Write_0:
        MOVS     R0,#+1
        LSLS     R0,R0,R2
        LDR.W    R2,??DataTable26_7  ;; 0x8300b064
        CMP      R1,#+0
...
//  235                 DRV_WriteReg32(IOT_GPIO_AON_BASE + IOT_GPIO_PU1_SET, (1 << remainder));
        MOVS     R0,#+1
        LSLS     R0,R0,R5
        LDR.W    R1,??DataTable26_11  ;; 0x8300b004
        STR      R0,[R1, #+0]
...
//  277                 DRV_WriteReg32(IOT_GPIO_AON_BASE + IOT_GPIO_PU1_RESET, (1 << remainder));
        MOVS     R0,#+1
        LSLS     R0,R0,R1
        LDR.W    R1,??DataTable27  ;; 0x8300b008
        STR      R0,[R1, #+0]
...
//  319                 DRV_WriteReg32(IOT_GPIO_AON_BASE + IOT_GPIO_PD1_SET, (1 << remainder));
        MOVS     R0,#+1
        LSLS     R0,R0,R5
        LDR.W    R1,??DataTable27_1  ;; 0x8300b034
        STR      R0,[R1, #+0]
...
//  363                 DRV_WriteReg32(IOT_GPIO_AON_BASE + IOT_GPIO_PD1_RESET, (1 << remainder));
        MOVS     R0,#+1
        LSLS     R0,R0,R1
        LDR.W    R1,??DataTable27_2  ;; 0x8300b038
        STR      R0,[R1, #+0]
...
??halGPIO_SetDriving_6:
        ...
        LDR.W    R0,??DataTable27_4  ;; 0x81023048
        LDR      R2,[R0, #+0]
        BIC      R2,R2,#0x1C0
        STR      R2,[R0, #+0]
        LDR      R2,[R0, #+0]
...
??topPAD_Control_GPIO_1:
        LDR.W    R0,??DataTable28  ;; 0x81021080
        LDR      R1,[R0, #+0]
        MOVS     R2,#+1
        LSLS     R2,R2,R3
        ORRS     R1,R2,R1
...
??halRegGPInterrupt_set_triggermode_10:
        ...
        ORRS     R1,R2,R1
        STR      R1,[R0, #+88]
        LDR.N    R0,??DataTable29_1  ;; 0x8300c204
        LSLS     R1,R4,#+14
        AND      R1,R1,#0x4000
        LDR      R2,[R0, #+4]
        BIC      R2,R2,#0x4000
...
// 6 942 bytes in section .text
// 
// 6 942 bytes of CODE memory

...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\timer.s
//
///////////////////////////////////////////////////////////////////////////////
...
//  138     if (timerNum == TMR0) {
        LDR.N    R0,??DataTable2_1  ;; 0x83050010
        CMP      R4,#+0
        BNE.N    ??drvTMR_init_0
...
//  173         DRV_Reg32(GPT_ISR) = GPT0_INT;
        MOVS     R1,#+1
        LDR.N    R2,??DataTable2_2  ;; 0x83050000
        STR      R1,[R2, #+0]
//  174     }
...
//  176         DRV_Reg32(GPT_ISR) = GPT1_INT;
        MOVS     R0,#+2
        LDR.N    R1,??DataTable2_2  ;; 0x83050000
        STR      R0,[R1, #+0]
//  177     }
//  178 }

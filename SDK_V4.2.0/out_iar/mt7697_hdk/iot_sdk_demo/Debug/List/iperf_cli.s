...
//    Endian       =  little
//    Source file  =  
//        C:\LEO\myGit\MTK IOT\SDK_V4.2.0\middleware\MTK\iperf\src\iperf_cli.c
//    Command line =  
//        "C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\middleware\MTK\iperf\src\iperf_cli.c" -D
...
//    List file    =  
//        C:\LEO\myGit\MTK
//        IOT\SDK_V4.2.0\out_iar\mt7697_hdk\iot_sdk_demo\Debug\List\iperf_cli.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   61 
//   62     g_iperf_param = pvPortMalloc(IPERF_COMMAND_BUFFER_NUM * IPERF_COMMAND_BUFFER_SIZE);
        MOV      R0,#+360
          CFI FunCall pvPortMalloc
        BL       pvPortMalloc
        MOVS     R5,R0
//   63     if (g_iperf_param == NULL) {
        BNE.N    ??_cli_iperf_server_0
//   64         IPERF_LOGI("Warning: No enough memory to running iperf.");
...
//   66     }
//   67 
//   68 #if defined(IPERF_DEBUG_INTERNAL)
//   69     IPERF_LOGI("_cli_iperf_server, g_iperf_param = 0x%x, param = 0x%x", g_iperf_param, param);
//   70 #endif
//   71 
//   72     for (i = 0; i < 13; i++) {
??_cli_iperf_server_0:
...
??_cli_iperf_server_2:
        CMP      R7,#+13
        BGE.N    ??_cli_iperf_server_4
//   73         strcpy((char *)&g_iperf_param[i * offset], param[i]);
        LDR      R1,[R4, R7, LSL #+2]
        ADD      R0,R7,R7, LSL #+2
        ADD      R0,R5,R0, LSL #+2
          CFI FunCall strcpy
        BL       strcpy
//   74 #if defined(IPERF_DEBUG_INTERNAL)
//   75         IPERF_LOGI("_cli_iperf_client, g_iperf_param[%d] is \"%s\"", i, (char *)&g_iperf_param[i * offset]);
//   76 #endif
//   77         if (param[i][0] == 0 &&  param[i][1] == 0) {
        LDR      R0,[R4, R7, LSL #+2]
        LDRB     R1,[R0, #+0]
        CMP      R1,#+0
        BNE.N    ??_cli_iperf_server_3
        LDRB     R0,[R0, #+1]
        CMP      R0,#+0
        BNE.N    ??_cli_iperf_server_3
//   78             break;
...
??_cli_iperf_server_4:
        MOV      R7,R6
        ADR.W    R8,??DataTable52  ;; 0x2D, 0x75, 0x00, 0x00
        B.N      ??_cli_iperf_server_5
??_cli_iperf_server_6:
        ADDS     R7,R7,#+1
??_cli_iperf_server_5:
        CMP      R7,#+13
        BGE.N    ??_cli_iperf_server_7
//   83         if (strcmp(param[i], "-u") == 0) {
        MOV      R1,R8
        LDR      R0,[R4, R7, LSL #+2]
          CFI FunCall strcmp
        BL       strcmp
        CMP      R0,#+0
        BNE.N    ??_cli_iperf_server_6
//   84             IPERF_LOGI("Iperf UDP Server: Start!");
        LDR.W    R6,??DataTable53
        ADR.W    R9,`_cli_iperf_server::__FUNCTION__`
        ADR.W    R0,?_8
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+84
        ...
        LDR      R12,[R6, #+8]
          CFI FunCall
        BLX      R12
//   85             IPERF_LOGI("Iperf UDP Server Receive Timeout = 20 (secs)");
        ADR.W    R0,?_9
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+85
        ...
        LDR      R6,[R6, #+8]
          CFI FunCall
        BLX      R6
//   86             xTaskCreate((TaskFunction_t)iperf_udp_run_server, IPERF_TASK_NAME, IPERF_TASK_STACKSIZE/ sizeof(portSTACK_TYPE), g_iperf_param, IPERF_TASK_PRIO , NULL);
        MOVS     R0,#+0
        STR      R0,[SP, #+12]
        STR      R0,[SP, #+8]
        STR      R0,[SP, #+4]
...
??_cli_iperf_server_7:
        ...
        BL       strcmp
        CMP      R0,#+0
        BEQ.N    ??_cli_iperf_server_8
//   94         IPERF_LOGI("Iperf TCP Server: Start!");
        ...
        LDR      R4,[R6, #+8]
          CFI FunCall
        BLX      R4
//   95         IPERF_LOGI("Iperf TCP Server Receive Timeout = 20 (secs)");
        ADR.W    R0,?_12
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+95
        ...
        LDR      R4,[R6, #+8]
          CFI FunCall
        BLX      R4
//   96         xTaskCreate((TaskFunction_t)iperf_tcp_run_server, IPERF_TASK_NAME, IPERF_TASK_STACKSIZE / sizeof(portSTACK_TYPE), g_iperf_param, IPERF_TASK_PRIO , NULL);
        MOVS     R0,#+0
        STR      R0,[SP, #+12]
        STR      R0,[SP, #+8]
        STR      R0,[SP, #+4]
...
//   98     }
//   99 
//  100     if (is_create_task == 0) {
??_cli_iperf_server_8:
        CMP      R6,#+0
        BNE.N    ??_cli_iperf_server_9
//  101         vPortFree(g_iperf_param);
        MOV      R0,R5
...
//  105 
        ...
        THUMB
//  106 static uint8_t _cli_iperf_client(uint8_t len, char *param[])
//  107 {
_cli_iperf_client:
        PUSH     {R0-R8,LR}
          CFI R14 Frame(CFA, -4)
        ...
        MOV      R4,R1
//  108     int i;
//  109     char **g_iperf_param = NULL;
//  110     int is_create_task = 0;
        MOVS     R5,#+0
//  111     int offset = IPERF_COMMAND_BUFFER_SIZE / sizeof(char *);
//  112 
//  113     g_iperf_param = pvPortMalloc(IPERF_COMMAND_BUFFER_NUM * IPERF_COMMAND_BUFFER_SIZE);
        MOV      R0,#+360
          CFI FunCall pvPortMalloc
        BL       pvPortMalloc
        MOVS     R6,R0
//  114     if (g_iperf_param == NULL) {
        BNE.N    ??_cli_iperf_client_0
//  115         IPERF_LOGI("Warning: No enough memory to running iperf.");
...
??_cli_iperf_client_2:
        CMP      R7,#+18
        BGE.N    ??_cli_iperf_client_4
//  120         strcpy((char *)&g_iperf_param[i * offset], param[i]);
        LDR      R1,[R4, R7, LSL #+2]
        ADD      R0,R7,R7, LSL #+2
        ADD      R0,R6,R0, LSL #+2
          CFI FunCall strcpy
        BL       strcpy
//  121 
//  122 #if defined(IPERF_DEBUG_INTERNAL)
//  123         IPERF_LOGI("_cli_iperf_client, g_iperf_param[%d] is \"%s\"", i, (char *)&g_iperf_param[i * offset]);
//  124 #endif
//  125 
//  126         if (param[i][0] == 0 &&  param[i][1] == 0) {
        LDR      R0,[R4, R7, LSL #+2]
        LDRB     R1,[R0, #+0]
        CMP      R1,#+0
        BNE.N    ??_cli_iperf_client_3
        LDRB     R0,[R0, #+1]
        CMP      R0,#+0
        BNE.N    ??_cli_iperf_client_3
//  127             break;
...
??_cli_iperf_client_4:
        MOV      R7,R5
        ADR.W    R8,??DataTable52  ;; 0x2D, 0x75, 0x00, 0x00
        B.N      ??_cli_iperf_client_5
??_cli_iperf_client_6:
        ADDS     R7,R7,#+1
??_cli_iperf_client_5:
        CMP      R7,#+18
        BGE.N    ??_cli_iperf_client_7
//  132         if (strcmp(param[i], "-u") == 0) {
        MOV      R1,R8
        LDR      R0,[R4, R7, LSL #+2]
          CFI FunCall strcmp
        BL       strcmp
        CMP      R0,#+0
        BNE.N    ??_cli_iperf_client_6
//  133             IPERF_LOGI("Iperf UDP Client: Start!");
        LDR.N    R0,??DataTable53
        ADR.W    R1,?_13
        STR      R1,[SP, #+0]
        MOV      R3,R5
        ...
        LDR      R5,[R0, #+8]
          CFI FunCall
        BLX      R5
//  134             xTaskCreate((TaskFunction_t)iperf_udp_run_client, IPERF_TASK_NAME, IPERF_TASK_STACKSIZE / sizeof(portSTACK_TYPE), g_iperf_param, IPERF_TASK_PRIO , NULL);
        MOVS     R0,#+0
        STR      R0,[SP, #+12]
        STR      R0,[SP, #+8]
        STR      R0,[SP, #+4]
        ...
        LDR.N    R0,??DataTable53_3
          CFI FunCall xTaskGenericCreate
        BL       xTaskGenericCreate
//  135             is_create_task = 1;
        MOVS     R5,#+1
//  136             break;
//  137         }
//  138     }
//  139 
//  140     if (strcmp(param[i], "-u") != 0) {
??_cli_iperf_client_7:
        MOV      R1,R8
        LDR      R0,[R4, R7, LSL #+2]
          CFI FunCall strcmp
        BL       strcmp
        CMP      R0,#+0
        BEQ.N    ??_cli_iperf_client_8
//  141         IPERF_LOGI("Iperf TCP Client: Start!");
        LDR.N    R0,??DataTable53
        ADR.W    R1,?_14
        STR      R1,[SP, #+0]
        MOVS     R3,#+0
        ...
        LDR      R4,[R0, #+8]
          CFI FunCall
        BLX      R4
//  142 #if (CFG_CONNSYS_TRX_BALANCE_EN == 1)
//  143         xTaskCreate((TaskFunction_t)iperf_tcp_run_client, IPERF_TASK_NAME, IPERF_TASK_STACKSIZE / sizeof(portSTACK_TYPE), g_iperf_param, IPERF_TASK_PRIO , (TaskHandle_t *)&g_balance_ctr.tx_handle);
//  144 #else
//  145         xTaskCreate((TaskFunction_t)iperf_tcp_run_client, IPERF_TASK_NAME, IPERF_TASK_STACKSIZE / sizeof(portSTACK_TYPE), g_iperf_param, IPERF_TASK_PRIO , NULL);
        MOVS     R0,#+0
        STR      R0,[SP, #+12]
        STR      R0,[SP, #+8]
        STR      R0,[SP, #+4]
        ...
        BL       xTaskGenericCreate
//  146 #endif
//  147         is_create_task = 1;
        MOVS     R5,#+1
//  148     }
//  149 
//  150     if (is_create_task == 0) {
??_cli_iperf_client_8:
        CMP      R5,#+0
        BNE.N    ??_cli_iperf_client_9
//  151         vPortFree(g_iperf_param);
        MOV      R0,R6
          CFI FunCall vPortFree
        BL       vPortFree
//  152     }
...
//  156 
        ...
        THUMB
//  157 static uint8_t _cli_iperf_help(uint8_t len, char *param[])
//  158 {
_cli_iperf_help:
        PUSH     {R4-R6,LR}
          CFI R14 Frame(CFA, -4)
        ...
        SUB      SP,SP,#+8
          CFI CFA R13+24
//  159 
//  160     IPERF_LOGI("Usage: iperf [-s|-c] [options]");
...
//  162     IPERF_LOGI("Client/Server:");
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  163     IPERF_LOGI("  -u,        use UDP rather than TCP");
        ADR.W    R0,?_18
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+163
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  164     IPERF_LOGI("  -p,    #    server port to listen on/connect to (default 5001)");
        ADR.W    R0,?_19
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+164
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  165     IPERF_LOGI("  -n,    #[kmKM]    number of bytes to transmit ");
        ADR.W    R0,?_20
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+165
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  166     IPERF_LOGI("  -b,    #[kmKM]    for UDP, bandwidth to send at in bits/sec");
        ADR.W    R0,?_21
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+166
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  167     IPERF_LOGI("  -i,        10 seconds between periodic bandwidth reports \n");
        ADR.W    R0,?_22
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+167
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  168     IPERF_LOGI("Server specific:");
        ADR.W    R0,?_23
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+168
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  169     IPERF_LOGI("  -s,        run in server mode");
        ADR.W    R0,?_24
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+169
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  170     IPERF_LOGI("  -B,    <ip>    bind to <ip>, and join to a multicast group (only Support UDP)");
        ADR.W    R0,?_25
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+170
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  171     IPERF_LOGI("  -r,        for UDP, run iperf in tradeoff testing mode, connecting back to client\n");
        ADR.W    R0,?_26
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+171
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  172     IPERF_LOGI("Client specific:");
        ADR.W    R0,?_27
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+172
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  173     IPERF_LOGI("  -c,    <ip>    run in client mode, connecting to <ip>");
        ADR.W    R0,?_28
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+173
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  174     IPERF_LOGI("  -w,    #[kmKM]    TCP window size");
        ADR.W    R0,?_29
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+174
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  175     IPERF_LOGI("  -l,    #[kmKM]    UDP datagram size");
        ADR.W    R0,?_30
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+175
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  176     IPERF_LOGI("  -t,    #    time in seconds to transmit for (default 10 secs)");
        ADR.W    R0,?_31
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+176
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  177     IPERF_LOGI("  -S,    #    the type-of-service of outgoing packets\n");
        ADR.W    R0,?_32
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+177
...
//  178     IPERF_LOGI("Miscellaneous:");
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  179     IPERF_LOGI("  -h,        print this message and quit\n");
        ADR.W    R0,?_34
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+179
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  180     IPERF_LOGI("[kmKM] Indicates options that support a k/K or m/M suffix for kilo- or mega-\n");
        ADR.W    R0,?_35
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+180
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  181     IPERF_LOGI("TOS options for -S parameter:");
        ADR.W    R0,?_36
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+181
...
//  185     IPERF_LOGI("VO: -S 224\n");
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  186     IPERF_LOGI("Tradeoff Testing Mode:");
        ADR.W    R0,?_41
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+186
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  187     IPERF_LOGI("Command: iperf -s -u -n <bits/bytes> -r \n");
        ADR.W    R0,?_42
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+187
...
//  188     IPERF_LOGI("Example:");
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  189     IPERF_LOGI("Iperf TCP Server: iperf -s");
        ADR.W    R0,?_44
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+189
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  190     IPERF_LOGI("Iperf UDP Server: iperf -s -u");
        ADR.W    R0,?_45
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+190
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  191     IPERF_LOGI("Iperf TCP Client: iperf -c <ip> -w <window size> -t <duration> -p <port>");
        ADR.W    R0,?_46
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+191
        ...
        LDR      R6,[R4, #+8]
          CFI FunCall
        BLX      R6
//  192     IPERF_LOGI("Iperf UDP Client: iperf -c <ip> -u -l <datagram size> -t <duration> -p <port>");
        ADR.W    R0,?_47
        STR      R0,[SP, #+0]
        MOVS     R3,#+0
        MOVS     R2,#+192
...
?_47:
        ...
        DC8 0
//  195 
//  196 #if defined(MTK_IPERF_DEBUG_ENABLE)
//  197 static uint8_t _cli_iperf_debug(uint8_t len, char *param[])
//  198 {
//  199     int debug;
//  200     debug = atoi(param[0]);
//  201     IPERF_LOGI("Set iperf debug to %d(0x%x)\n", debug, debug);
//  202     iperf_set_debug_mode(debug);
//  203     return 0;
//  204 }
//  205 #endif
//  206 
...
?_7:
        ...
        END
//  208     { "-s",        "iperf server",               _cli_iperf_server   },
//  209     { "-c",        "iperf client",               _cli_iperf_client   },
//  210     { "-h",                "help",               _cli_iperf_help     },
//  211 #if defined(MTK_IPERF_DEBUG_ENABLE)
//  212     { "-d",               "debug",               _cli_iperf_debug    },
//  213 #endif
//  214     { NULL }
//  215 
//  216 };

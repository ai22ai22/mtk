...
MM_ERROR_CODE_ENUM BF3901_SERIALWebcamFeatureCtrl(kal_uint32 Id, void *In, void *Out, kal_uint32 OutLen, kal_uint32 *RealOutLen)
{
  ...
  static const USBVideo_Attr_Info BF3901_SERIAL_ATTR_INFO[] =
  {
  ...
  static const USBVideo_Video_Size_Info BF3901_SERIAL_VIDEO_SIZE[] =
  {
  ...
  static const USBVideo_Still_Size_Info BF3901_SERIAL_STILL_SIZE[] =
  {
  ...
  static const USBVideo_Compression_Info BF3901_SERIAL_STILL_COMPRESSION[] =
  {
  ...
  static const USBVIDEO_VIDEO_SIZE_TYPE BF3901_SERIAL_g_default_video_size = USBVIDEO_VIDEO_SIZE_1;
  static const USBVIDEO_STILL_SIZE_TYPE BF3901_SERIAL_g_default_still_size = USBVIDEO_STILL_SIZE_1;
  static const USBVIDEO_COMPRESSION_TYPE BF3901_SERIAL_g_default_compression = USBVIDEO_COMPRESSION_1;
  static const usbvideo_attr_struct BF3901_SERIALWebcamAttrPara =
  {
    /* min,max,res,def */
    {
      ...
      else
      {
        if (AttrType >= ATTR_PU_START)
        {
          ...
          case USBVIDEO_REQUEST_GET_MIN:
            pWebCamAttr->value = BF3901_SERIALWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].min;
            break;
          case USBVIDEO_REQUEST_GET_MAX:
            pWebCamAttr->value = BF3901_SERIALWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].max;
            break;
          case USBVIDEO_REQUEST_GET_DEF:
            pWebCamAttr->value = BF3901_SERIALWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].def;
            break;
          case USBVIDEO_REQUEST_GET_RES:
            pWebCamAttr->value = BF3901_SERIALWebcamAttrPara.attr_info[GET_ATTR_PU_IDX(AttrType)].res;
            break;
          default:
  ...
  case CAL_FEATURE_WEBCAM_SET_ATTR:
    {
      ...
      BF3901_SERIALSensorFunc(&pfSensorFunc);
  ...
  case CAL_FEATURE_WEBCAM_GET_ATTR_INFO:
    ((P_CAL_FEATURE_WEBCAM_GET_ATTR_INFO_STRUCT)Out)->pWebCamAttrInfo = BF3901_SERIAL_ATTR_INFO;
    ((P_CAL_FEATURE_WEBCAM_GET_ATTR_INFO_STRUCT)Out)->WebCamAttrInfoNum = sizeof(BF3901_SERIAL_ATTR_INFO) / sizeof(BF3901_SERIAL_ATTR_INFO[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE:
    ((P_CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE_STRUCT)Out)->pWebCamVideoSizeInfo = BF3901_SERIAL_VIDEO_SIZE;
    ((P_CAL_FEATURE_WEBCAM_GET_VIDEO_SIZE_STRUCT)Out)->WebCamVideoSizeInfoNum = sizeof(BF3901_SERIAL_VIDEO_SIZE) / sizeof(BF3901_SERIAL_VIDEO_SIZE[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_STILL_SIZE:
    ((P_CAL_FEATURE_WEBCAM_GET_STILL_SIZE_STRUCT)Out)->pWebCamStillSizeInfo = BF3901_SERIAL_STILL_SIZE;
    ((P_CAL_FEATURE_WEBCAM_GET_STILL_SIZE_STRUCT)Out)->WebCamStillSizeInfoNum = sizeof(BF3901_SERIAL_STILL_SIZE) / sizeof(BF3901_SERIAL_STILL_SIZE[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_COMPRESSION:
    ((P_CAL_FEATURE_WEBCAM_GET_COMPRESSION_STRUCT)Out)->pWebCamCompressionInfo = BF3901_SERIAL_STILL_COMPRESSION;
    ((P_CAL_FEATURE_WEBCAM_GET_COMPRESSION_STRUCT)Out)->WebCamCompressionInfoNum = sizeof(BF3901_SERIAL_STILL_COMPRESSION) / sizeof(BF3901_SERIAL_STILL_COMPRESSION[0]);
    break;
  case CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX:
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamVideoSizeIdx = BF3901_SERIAL_g_default_video_size;
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamStillSizeIdx = BF3901_SERIAL_g_default_still_size;
    ((P_CAL_FEATURE_WEBCAM_GET_DEFAULT_IDX_STRUCT)Out)->WebCamCompressionIdx = BF3901_SERIAL_g_default_compression;
    break;
  default:

...
const unsigned char cmdlist_suspend_winbond[] = {
    SPI, 1, 0x75, SF_UNDEF
};
const unsigned char cmdlist_resume_winbond[] = {
    SPI, 1, 0x7A, SF_UNDEF
};
...
{
    sfc_Command_List(cmdlist_suspend_winbond);
    return;
}
...
{
    sfc_Command_List(cmdlist_resume_winbond);
    return;
}

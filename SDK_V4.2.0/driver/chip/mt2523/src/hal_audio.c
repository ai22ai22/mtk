...
hal_audio_status_t hal_audio_start_stream_out(hal_audio_active_type_t active_type)
{
    ...
    if (active_type == HAL_AUDIO_PLAYBACK_MUSIC_RECORD_VOICE) {
        if ((audio_config.stream_in.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_16KHZ && audio_config.stream_out.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_8KHZ) ||
            (audio_config.stream_in.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_16KHZ && audio_config.stream_out.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_11_025KHZ) ||
            (audio_config.stream_in.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_16KHZ && audio_config.stream_out.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_12KHZ)) {
...
hal_audio_status_t hal_audio_start_stream_in(hal_audio_active_type_t active_type)
{
    if (active_type == HAL_AUDIO_PLAYBACK_MUSIC_RECORD_VOICE) {
        if ((audio_config.stream_in.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_16KHZ && audio_config.stream_out.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_8KHZ) ||
            (audio_config.stream_in.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_16KHZ && audio_config.stream_out.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_11_025KHZ) ||
            (audio_config.stream_in.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_16KHZ && audio_config.stream_out.stream_sampling_rate == HAL_AUDIO_SAMPLING_RATE_12KHZ)) {
            log_hal_info("hal_audio_start_stream_in not support\n");
            return HAL_AUDIO_STATUS_ERROR;
        }
    }

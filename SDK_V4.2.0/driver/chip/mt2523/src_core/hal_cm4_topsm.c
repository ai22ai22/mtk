...
ATTR_RWDATA_IN_TCM volatile uint32_t origin_msp_bak_reg, origin_psp_bak_reg, backup_return_address, spi_cg_status;
...
void cm4_topsm_wakeup_init()
{
    ...
    *CM4_TOPSM_DBG_WAKEUP = 0x80000000; /*Cirq mask enable*/
    cm4_topsm_wakeup_unmask_all_irq();
...
ATTR_TEXT_IN_TCM void cm4_topsm_enter_suspend(hal_sleep_mode_t mode)
{
    ...
    if (SLEEP_MANAGER_DEBUG) {
        log_hal_info("[Start Enter Sleep]\n");
    }
...
ATTR_TEXT_IN_TCM void cm4_topsm_enter_deep_sleep(hal_sleep_mode_t mode)
{
    ...
    *((volatile uint32_t *)0xA20F0030) |= 0x10000;
    ...
    if ((*(volatile uint32_t *)(0xa2010304) & 0x00f00000) != 0x00f00000) {
        spi_cg_status = 1;
    } else {
        spi_cg_status = 0;
        /* enable SPI CG */
        *(volatile uint32_t *)(0xa2010324) = 0x00f00000;
    }
...
//#endif
    ...
    /* disable SPI CG */
    if (spi_cg_status == 0) {
        *(volatile uint32_t *)(0xa2010314) = 0x00f00000;
        spi_cg_status = 0;
    }

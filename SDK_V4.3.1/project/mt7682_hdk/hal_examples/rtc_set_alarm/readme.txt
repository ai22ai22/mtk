...
@par Run the example
  ...
  - Run the example. The log will show the current time and alarm time. The
    result in the system log, such as "RTC current time:2015, 11, 6 (5)
    15:26:25", indicates the alarm is setup successfully.
*/
/**
 * @}
 * @}

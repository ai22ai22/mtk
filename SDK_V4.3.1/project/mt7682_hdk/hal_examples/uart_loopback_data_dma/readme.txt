...
@par Overview
  ...
  - Input to the example
    - User inputs the test data into UART0.
  - Results
    - UART0 outputs the received test data from the user.
...
@par Run the example
  ...
  - Run the example. Input test data into UART0 with the serial tool. The
    test data ("0123456789abcdef") is then received from UART0 and displayed

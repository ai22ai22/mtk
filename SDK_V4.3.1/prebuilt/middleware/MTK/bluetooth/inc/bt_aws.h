...
#define BT_AWS_CUSTOM_STREAMING_RECEIVED_IND  (BT_MODULE_AWS | 0x0013)       /**< The AWS streaming information is available. */
#define BT_AWS_MODE_SET_IND            (BT_MODULE_AWS | 0x0014)
#define BT_AWS_MODE_SET_CNF            (BT_MODULE_AWS | 0x0015)
...
/**
 * @brief This structure defines the aws mode.
 */
typedef uint8_t bt_aws_mode_t;
#define BT_AWS_MODE_NONE       0x00                      /**< The AWS mode of NONE. */
#define BT_AWS_MODE_A2DP       0x01                      /**< The AWS mode of A2DP. */
#define BT_AWS_MODE_MP3        0x02                      /**< The AWS mode of MP3. */
...
#define BT_AWS_COMMAND_ID_RESYNC        0x05         /**< The command ID of resync. */
#define BT_AWS_COMMAND_ID_MODE_CHANGE   0x06         /**< The command ID of mode change. */
...
/**
 *  @brief This structure defines the BT_AWS_MODE_SET_IND result.
 */
typedef struct {
    uint32_t handle;           /**< AWS handle. */
    bt_aws_mode_t aws_mode;        /**< AWS mode. */
} bt_aws_mode_set_ind_t;
...
/**
 *  @brief This structure defines the BT_AWS_CUSTOM_STREAMING_RECEIVED_IND result.
 */
typedef struct {
    uint32_t handle;                             /**< AWS handle. */
    uint8_t *data;                          /**< Media data pointer. */
    uint16_t data_length;                       /**< The total length of Media packet. */
} bt_aws_custom_streaming_received_ind_t;
...
bt_status_t bt_aws_set_role_request(uint32_t handle, bt_aws_role_t local_role);
...
uint16_t bt_aws_send_streaming_packet(uint32_t handle, uint8_t *streaming_data, uint16_t data_len);

bt_status_t bt_aws_set_mode_request(uint32_t handle, bt_aws_mode_t aws_mode);

bt_status_t bt_aws_set_mode_response(uint32_t handle, bool accept);

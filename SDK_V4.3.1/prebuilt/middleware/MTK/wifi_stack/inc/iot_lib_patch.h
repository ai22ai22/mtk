...
#if (MT7682_BORA00009023 == 1)
typedef struct _wlan_counters {
	UINT_32 TX_Count;
	UINT_32 TX_Retry_Count;
	UINT_32 TX_Ack_fail_Count;
	UINT_32 RX_SNR;
	UINT_32 RX_PER;
	UINT_32 Cipher_err_count;
	UINT_32 Mic_error;
	UINT_32 FCS_Error;
	UINT_32 EDCCA_Error;
} wlan_counters, *pwlan_counters;

UINT_32 get_tx_retry_count();
UINT_32 get_rx_per();

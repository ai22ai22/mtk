...
- Add some new config parameter in wearable_config.xml.
...
3. Study <MediaTek_IoT_SmartDevice_App_Programming_Guide> pdf and JavaDoc to understand BTNotify transport protocol, related API, how to implement your own controller and customize your APP.
4. Study <MT2511_Health_Module_Programming_Guide> to understand implementation detail of MT2511 Health features.
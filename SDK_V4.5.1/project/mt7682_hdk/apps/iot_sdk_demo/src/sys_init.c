...
static void fastTx_init(uint32_t channel)
{
    g_FastTx_Channel = channel;
}

static void fastTx_PktSend(PUINT_8 pPktContent, UINT_32 PktLen)
{
    PktSendbyPSE(pPktContent, PktLen);
}
#endif
...
void system_init(void)
{
    ...
    fastTx_PktSend(DemoPkt, DemoPktLen);
#endif

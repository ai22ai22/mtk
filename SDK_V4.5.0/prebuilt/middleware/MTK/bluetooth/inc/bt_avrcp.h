...
typedef struct{
    ...
    uint8_t attribute_value[];                              /**< The attribute value with a specified character set. */
 ...
 * @return              #BT_STATUS_SUCCESS, the pass-through command is sent successfully. #BT_STATUS_AVRCP_INVALID_PARAMETER, the handle is NULL.

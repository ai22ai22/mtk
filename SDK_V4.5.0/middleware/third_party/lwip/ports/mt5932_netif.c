...
mt5932_ethernetif_init(ip4_addr_t *sta_ip_addr, ip4_addr_t *sta_net_mask, ip4_addr_t *sta_gw,
                             ...
                             uint8_t opmode)
{
#if 0 //defined(MTK_WIFI_STUB_CONF_ENABLE) && (MTK_WIFI_STUB_CONF_SPIM_ENABLE || MTK_WIFI_STUB_CONF_SDIO_MSDC_ENABLE || MTK_WFC_WITH_LWIP_NO_WIFI_ENABLE)

#if (MTK_WIFI_STUB_CONF_SPIM_ENABLE || MTK_WIFI_STUB_CONF_SDIO_MSDC_ENABLE)  
    uint8_t sta_mac_address[6] = {0x00, 0x0c, 0x43, 0x76, 0x86, 0x09}; //Keep the same as WiFi MAC

...
#else
#define SDIO_GEN3_BASE          (0xC00F0000)
#endif
...
#else
// MT7686
#define CONNSYS_GDMA_CH            6

#define GDMA_CH6_BASE          (CM4_DMA_BASE+0x600)
#define GDMA_CH6_COUNT         (GDMA_CH6_BASE+0x10)
#define GDMA_CH6_CON           (GDMA_CH6_BASE+0x14)
#define GDMA_CH6_START         (GDMA_CH6_BASE+0x18)
#define GDMA_CH6_PGMADDR       (GDMA_CH6_BASE+0x2c)
#define GDMA_CH6_RLCT          (GDMA_CH6_BASE+0x24)
#define PDN_CLR0               (0xA21D0320)
// mt7686 for clear all clock gating
#define GDMA_CHANNEL_ENABLE     (0xA21d0320)
#endif
/* ==================== HW Definition ============ */

 ...
 * @param[in] hal_i2s_port_t is the I2S HW number. Please refer to #hal_i2s_port_t.
 * @param[in] i2s_initial_type is the initial configuration parameter. Please refer to #hal_i2s_initial_type_t.
 * @return  #HAL_I2S_STATUS_INVALID_PARAMETER, if input parameter is invalid. \n
 ...
 * @param[in] byte_count is the available free space in the output buffer. (in bytes)
 ...
 *                #HAL_I2S_STATUS_OK, if the operation is successful.
 * @note       Call this function before #hal_i2s_tx_write_buffer_ex() function to ensure there is enough free space in the TX VFIFO buffer for the write operation.
 * @sa         #hal_i2s_tx_write_buffer_ex()
 */
 ...
 * @return     #HAL_I2S_STATUS_OK, if the operation is successful. \n
               The return value is reserved for further expansion. The current value is always set to #HAL_I2S_STATUS_OK.
 * @note       Call this function before #hal_i2s_rx_read_buffer_ex() function to ensure there is data available in the RX VFIFO buffer to perform read operation.
 * @sa         #hal_i2s_rx_read_buffer_ex()
 */
